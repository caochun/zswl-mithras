 ...
 * 非监管户资金(元)
 *
 * 账户明细表中当日账户性质=非监管户的结余（实际）之和
 * 无结余（实际）则取结余（预估）
 * @author chenyifei
 * @since 2024/12/20
 */
@Component
public class NonSupervisedAccountFundsCalculator extends AbstractLiquidityCalculator<LiquidityBoardCalculatorBo> {
    ...
    public String indexName() {
        return "nonSupervisedAccountFunds";
    }
