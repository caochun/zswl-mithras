 ...
 * @description 日期=当日，账户性质=非监管
 * result = 提款+租金回流+其它流入-投放(还本付息+还本付息(调整值))-刚性支出-其它支出
 */
@Slf4j
@Component
public class DailyNonSupervisedAccountIncomeCalculator extends AbstractLiquidityCalculator<LiquidityBoardCalculatorBo> {
    @Override
    ...
    public String indexName() {
        return "dailyNonSupervisedAccountIncome";
    }
}
