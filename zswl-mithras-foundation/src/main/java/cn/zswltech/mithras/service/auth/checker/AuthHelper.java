...
import cn.zswltech.mithras.service.auth.DataAuthBusinessModuleResolver;
...
public class AuthHelper {
    ...
    @Resource
    private DataAuthBusinessModuleResolver dataAuthBusinessModuleResolver;
     ...
     * @return
     */
    public Object getAuthObj(DataAuthBusinessModule businessModule, Object mainObject) {
        if (Objects.isNull(mainObject)) {
            return mainObject;
        }
        DataAuthBusinessModule relateBusinessModule = dataAuthBusinessModuleResolver.resolve(businessModule.getSponsorModule());
    ...
    public List<Object> getAuthObjList(DataAuthBusinessModule businessModule, List<Object> mainObjectList) {
     ...
     * @return
     */
    public Long getMainIdFromSubTable(DataAuthBusinessModule businessModule, Class<? extends BaseMapper> helperMapperClass, Long keyId) {
     ...
     * @return
     */
    public List<Long> listMainIdFromSubTable(DataAuthBusinessModule businessModule, Class<? extends BaseMapper> helperMapperClass, Collection<Long> keyIdList) {
        BaseMapper subTableMapper = SpringContextHolder.getBean(helperMapperClass);
