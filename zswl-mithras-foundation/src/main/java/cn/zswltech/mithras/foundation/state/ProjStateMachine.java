...
import cn.zswltech.mithras.foundation.state.actions.ProcessStateChangeAction;
...
import static cn.zswltech.mithras.foundation.state.ProjEvent.*;
import static cn.zswltech.mithras.foundation.state.ProjProcessState.NEW_REJECT;
import static cn.zswltech.mithras.foundation.state.ProjProcessState.*;
