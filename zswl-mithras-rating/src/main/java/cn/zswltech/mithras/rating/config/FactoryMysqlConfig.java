package cn.zswltech.mithras.rating.config;
...
@Configuration
@Slf4j
@MapperScan(value = "cn.zswltech.mithras.rating.mapper", sqlSessionFactoryRef = "factorySqlSessionFactory")
...
//        });
    ...
    public Resource[] resolveMapperLocations() {
        ...
        mapperLocations.add("classpath*:rating/mapper/*.xml");
