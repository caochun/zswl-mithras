...
import cn.zswltech.mithras.rating.versioning.ratingclient.impl.RatingClientVersionServiceImpl;
import cn.zswltech.mithras.rating.mapper.AreaInfoMapper;
...
import static cn.zswltech.mithras.foundation.constant.Constant.hymxScoreMap;
import static cn.zswltech.mithras.foundation.constant.Constant.subjectVesselSet;
...
//        }
        ...
        if (!isIntraGroupCollaboration(clientId)) {
            // 非公海需要判断管护权和申办权
            ...
            List<ClientAuthority> clientAuthorityList = clientAuthorityMapper.selectList(queryWrapper);
            boolean canDo = false;
...
//            }
    ...
    public void checkCancelProcess(Long ratingClientId) {
        ...
        Map<Long, Long> clientRemainingPrincipalMap = ratingClientSupportPort.getClientRemainingPrincipalMap(Collections.singletonList(byId.getClientId()));
...
//            RatingClientDetailLibRSP libRSP = libService.detail(ratingClient.getId());
    ...
    public ProcessResp findRelatedProcess(Long ratingClientId) {
        ...
        processPageReq.setModelKeyList(Arrays.asList(ProcessModelTypeEnum.RatingClientCreateFlow.name(),
                ProcessModelTypeEnum.RatingClientUpdateFlow.name()));
...
//            return areaModelIndexReflect(areaModelResult);
    ...
    private boolean isIntraGroupCollaboration(Long clientId) {
        ...
        return Objects.equals(corpCommerceInfo.getRiskControlIndustryClassify(),
