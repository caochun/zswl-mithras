 ...
 */
@Service
public class DashboardProjectInfoService extends DashboardProjectService implements DashboardProjectInfoApplicationService {
    @Resource
    ...
    private DashboardProjectFinanceStatisticsRSP rentInThisMonthStatisticsFinanceGroup(AccountVO accountVO) {
        ...
        rsp.setPlanRentAmountThisMonth(new ValueUnitDTO(DashboardAmountUtil.toWanYuanWithoutSplit(planAmount), "万元"));
        rsp.setUncollectionRentAmountThisMonth(new ValueUnitDTO(DashboardAmountUtil.toWanYuanWithoutSplit(planAmount - collectionAmount), "万元"));
        return rsp;
    }
    ...
    private DashboardProjectFinanceStatisticsRSP provisionStatisticsFinanceGroup(AccountVO accountVO) {
        ...
        rsp.setTotalExposure(new ValueUnitDTO(DashboardAmountUtil.toWanYuanWithoutSplit(totalExposure), "万元"));
        rsp.setProvisionBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toWanYuanWithoutSplit(totalProvision), "万元"));
        return rsp;
    }
    ...
    private DashboardProjectFinanceStatisticsRSP noSettleStatisticsFinanceGroup(AccountVO accountVO) {
        ...
        rsp.setQuantity(dbList.size());
        rsp.setRentBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toWanYuanWithoutSplit(totalPlanRentAmount - totalCollectionRentAmount), "万元"));
        return rsp;
    }
    ...
    private DashboardProjectInfoStatisticsRSP settleInThreeStatistics(AccountVO accountVO, DashboardProjectInfoStatisticsListREQ req) {
        ...
        return new DashboardProjectInfoStatisticsRSP(DashboardCardGroupEnum.PROJECT_VIEW_INFO_SETTLE_IN_THREE_MONTH.name(), DashboardCardGroupEnum.PROJECT_VIEW_INFO_SETTLE_IN_THREE_MONTH.display(), projReviewIds.size(), new ValueUnitDTO(DashboardAmountUtil.toWanYuanWithoutSplit(totalAmount), "万元"));
    }
    ...
    private DashboardProjectInfoStatisticsRSP overdueStatistics(AccountVO accountVO, DashboardProjectInfoStatisticsListREQ req) {
        ...
        return new DashboardProjectInfoStatisticsRSP(DashboardCardGroupEnum.PROJECT_VIEW_INFO_OVERDUE.name(), DashboardCardGroupEnum.PROJECT_VIEW_INFO_OVERDUE.display(), projReviewIds.size(), new ValueUnitDTO(DashboardAmountUtil.toWanYuanWithoutSplit(totalAmount), "万元"));
    }
    ...
    private DashboardProjectInfoStatisticsRSP rentInThisMonthStatistics(AccountVO accountVO, DashboardProjectInfoStatisticsListREQ req) {
        ...
        return new DashboardProjectInfoStatisticsRSP(DashboardCardGroupEnum.PROJECT_VIEW_INFO_RENT_IN_MONTH.name(), DashboardCardGroupEnum.PROJECT_VIEW_INFO_RENT_IN_MONTH.display(), projReviewIds.size(), new ValueUnitDTO(DashboardAmountUtil.toWanYuanWithoutSplit(totalAmount), "万元"));
    }
    ...
    public SettleInThreeMonSumRSP listSettleInThreeMonth(DashboardProjectInfoSettleInThreeMonthREQ req) {
        ...
        List<DashboardProjectInfoSettleInThreeMonthRSP> rspList = this.buildRspList(dbList, dbResult -> {
            ...
            long planPrincipal = Optional.ofNullable(dbResult.getTotalPlanPrincipal()).orElse(0L);
            long planInterest = Optional.ofNullable(dbResult.getTotalPlanInterest()).orElse(0L);
            rsp.setCollectionAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(collectionInterest + collectionPrincipal), "元"));
            rsp.setRemainingAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(planPrincipal + planInterest - collectionPrincipal - collectionInterest), "元"));
            rsp.setEarnestBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(earnestBalance), "元"));
            rsp.setCollectionPrincipalAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(collectionPrincipal), "元"));
            rsp.setCollectionInterestAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(collectionInterest), "元"));
            rsp.setPrincipalBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(planPrincipal - collectionPrincipal), "元"));
            rsp.setInterestBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(planInterest - collectionInterest), "元"));
            return rsp;
        });
    ...
    public OverDueSumRSP listOverdue(DashboardProjectInfoOverdueREQ req) {
        ...
        List<DashboardProjectInfoOverdueRSP> rspList = this.buildRspList(dbList, dbResult -> {
            ...
            rsp.setOverdueAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(overdueAmount), "元"));
            ...
            rsp.setInterestPenaltyAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(penaltyInterestAmount), "元"));
            long penaltyInterestDeductionAmount = Optional.ofNullable(dbResult.getPenaltyInterestDeductionAmount()).orElse(0L);
            rsp.setInterestPenaltyReduceAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(penaltyInterestDeductionAmount), "元"));
            return rsp;
        });
        this.fillGuarantorInfo(rspList);
        //数量/金额 合计
    ...
    public RentThisMonthSumRSP listRentThisMonth(DashboardProjectInfoRentThisMonthREQ req) {
        ...
        List<DashboardProjectInfoRentThisMonthRSP> rspList = this.buildRspList(dbList, dbResult -> {
            ...
            rsp.setRent(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(planRent), "元"));
            rsp.setCreditAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(totalPay), "元"));
            rsp.setPrincipalAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(planPrincipal), "元"));
            rsp.setInterestAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(planInterest), "元"));
            rsp.setBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(planRent - collectionRent), "元"));
            rsp.setPrincipalBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(planPrincipal - collectionPrincipal), "元"));
            rsp.setInterestBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(planInterest - collectionInterest), "元"));
            rsp.setCollectionPrincipalAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(collectionPrincipal), "元"));
            rsp.setCollectionInterestAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(collectionInterest), "元"));
            rsp.setCollectionRentAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(collectionPrincipal + collectionInterest), "元"));
    ...
    public List<DashboardProjectPayNoSettleRSP> listPayNoSettle(DashboardProjectPayNoSettleREQ req) {
        ...
        List<DashboardProjectPayNoSettleRSP> rspList = this.buildRspList(dbList, dbResult -> {
            ...
            rsp.setContractId(dbResult.getContractId());
            rsp.setActualPayAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(dbResult.getTotalPayAmount()), "元"));
            ...
            rsp.setStockRiskExposure(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(exposure), "元"));
            ...
            rsp.setBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(balance), "元"));
            ...
            rsp.setPrincipalBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(balancePrincipal), "元"));
            ...
            rsp.setInterestBalanceAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(balanceInterest), "元"));
            rsp.setEarnestAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(Optional.ofNullable(dbResult.getEarnestMoney()).orElse(0L)), "元"));
    ...
    public List<DashboardProjectProvisionRSP> listProvision(DashboardProjectProvisionREQ req) {
        ...
        return dbList.stream().map(dbResult -> {
            ...
            if (Objects.nonNull(dbResult.getContractAmount())) {
                rsp.setContractAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(dbResult.getContractAmount()), "元"));
            }
            if (Objects.nonNull(dbResult.getRemainingPrincipal())) {
                rsp.setPrincipalBalance(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(dbResult.getRemainingPrincipal()), "元"));
            }
            if (Objects.nonNull(dbResult.getEarnestBalance())) {
                rsp.setEarnest(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(dbResult.getEarnestBalance()), "元"));
            }
            if (Objects.nonNull(dbResult.getExposure())) {
                rsp.setStockRiskExposure(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(dbResult.getExposure()), "元"));
            }
            if (Objects.nonNull(dbResult.getDeadline())) {
            ...
            if (Objects.nonNull(dbResult.getProvisionBalance())) {
                rsp.setProvision(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(dbResult.getProvisionBalance()), "元"));
            }
    ...
    public List<DashboardProjectPledgeRSP> listPledge(DashboardProjectPledgeREQ req) {
        ...
        List<DashboardProjectPledgeRSP> rspList = resultList.stream().map(result -> {
            ...
            rsp.setRemainingPrincipal(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(remainingPrincipal > 0 ? remainingPrincipal : 0L), "元"));
            rsp.setResidualRent(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(residualRent > 0 ? residualRent : 0L), "元"));
            rsp.setTotalPayAmount(new ValueUnitDTO(DashboardAmountUtil.toYuanWithoutSplit(result.getTotalPayAmount()), "元"));
