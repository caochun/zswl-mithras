...
import cn.zswltech.mithras.dashboard.application.DashboardProjectInfoApplicationService;
...
public class DashboardProjectInfoController implements DashboardProjectInfoApi {
    @Resource
    private DashboardProjectInfoApplicationService dashboardProjectInfoService;
