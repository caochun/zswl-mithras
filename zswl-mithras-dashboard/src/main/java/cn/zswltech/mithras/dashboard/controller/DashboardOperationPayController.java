...
import cn.zswltech.mithras.dashboard.application.DashboardOperationPayApplicationService;
...
public class DashboardOperationPayController implements DashboardOperationPayApi {
    @Resource
    private DashboardOperationPayApplicationService dashboardOperationPayService;
