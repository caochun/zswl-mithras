...
const typoResidueFilePattern =
  /(?:^|[\\/])[^\\/]*(?:indes|indx|stlye|sytle|modle|compontent|componet|conifg|colums|untils|classifaction|towd|compony|applicat(?!ion))[^\\/]*\.(?:js|jsx|ts|tsx|less|css|scss|sass)$/i
const componentTypoResidueDirPattern =
  /^src[\\/]components[\\/].*[\\/][^\\/]*(?:singe|filling|snapshoot|colums|untils|indes|indx|stlye|sytle|modle|compontent|componet|conifg|haders|towd|compony|applicat(?!ion))[^\\/]*$/i
...
const removedLegacyComponentFiles = new Map([
  ...
  [
    'src/components/Contract/BaseInfo/index.js',
    'src/components/Contract/BaseInfo/ContractBaseInfo.js',
  ],
  [
    'src/components/Contract/ApplicationDetail/index.js',
    'src/components/Contract/ApplicationDetail/ContractApplicationDetail.js',
  ],
  [
  ...
  [
    'src/components/Contract/ChangeDetail/index.js',
    'src/components/Contract/ChangeDetail/ContractChangeDetail.js',
  ],
  [
  ...
  [
    'src/components/Financial/LiquidityRisk/index.js',
    'src/components/Financial/LiquidityRisk/FinancialLiquidityRisk.js',
  ],
  [
    'src/components/Financial/Liquidity/SupervisionAccount/index.js',
  ...
  [
    'src/components/LifeCycle/CustomerDetail/index.js',
    'src/components/LifeCycle/CustomerDetail/LifeCycleCustomerDetail.js',
  ],
  [
  ...
  [
    ...
    'src/components/Project/ReviewDetail/Log/ProjectReviewDetailLog.js',
  ],
  [
...
const stabilizedComponentRootImports = new Map([
  ...
  ['FileList', 'Format internal FileList or DataUpload.List'],
...
for (const filePath of sourceFiles) {
  ...
  if (
    relativeFilePath.startsWith('src/components/Cpm/') &&
    /\bdesSmell\b/.test(source)
  ) {
    violations.push({
      file: relativeFilePath,
      specifier: 'CPM description style typo residue (use summaryDescription naming)',
    })
  }
...
const removedCompatibilityComponentEntries = new Map([
  ...
  ['Budget/ProvisioningSharedEntries.js', 'Budget/Provisioning*Entries.js'],
  ...
  ['Contract/ProcessPrepareDetailEntries.js', 'Contract/*DetailEntries.js'],
  ...
  ['CreditManage/CreditManageEntries.js', 'CreditManage/* narrow Entries.js'],
  ['Customer/MaintainEntries.js', 'Customer/Maintain*Entries.js'],
  ['Dashboard/DashboardEntries.js', 'Dashboard/* narrow Entries.js'],
  ['Dashboard/SsoEntries.js', 'Dashboard/SsoLoginEntries.js or Dashboard/SsoFlowEntries.js'],
  ['Dashboard/WorkbenchEntries.js', 'Dashboard/WorkbenchPageEntries.js or Dashboard/WorkbenchRedirectEntries.js'],
  ['EvaluationAgency/EvaluationAgencyEntries.js', 'EvaluationAgency/AppraisalAgencyEntries.js'],
  ['ExternalEmbed/ExternalEmbedEntries.js', 'ExternalEmbed/DashBulletinBoardEntries.js or ExternalEmbed/JfBulletinBoardEntries.js'],
  ...
  ['Report/ManagementEntries.js', 'Report/ManagementPageEntries.js or Report/InternalHistoryEntries.js'],
  ...
  ['Permission/AuthEntries.js', 'Permission/LoginEntries.js or Permission/NewPasswordEntries.js'],
  ['Permission/BifrostEntries.js', 'Permission/* narrow Entries.js'],
  ['Preview/PreviewEntries.js', 'Preview/PdfPreviewEntries.js or Preview/ReportPreviewEntries.js'],
