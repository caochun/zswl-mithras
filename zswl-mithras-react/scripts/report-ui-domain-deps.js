...
const componentEntryScopeAliases = new Map([
  ...
  ['AfterLease/PolicyManageBaseEntries', 'AfterLeasePolicyManageBase'],
  ...
  ['Contract/ProcessApprovalDetailEntries', 'ContractProcessApprovalDetail'],
  ['Contract/ProcessPrepareDetailEntries', 'ContractProcessPrepareDetail'],
  ['Contract/ProcessRouteDetailEntries', 'ContractProcessRouteDetail'],
  ...
  ['Financial/FundListComponentEntries', 'FinancialFundListComponent'],
  ...
  ['Project/ReviewDetailSectionEntries', 'ProjectReviewDetailSection'],
