...
const stableSharedBusinessTargets = new Set([
  ...
  'components/RentCollectionListRender',
...
const componentEntryScopeAliases = new Map([
  ...
  ['AfterLease/CheckPlanStrategyColumnEntries', 'AfterLeaseCheckPlanStrategyColumn'],
  ['AfterLease/CheckPlanStrategyCreateEntries', 'AfterLeaseCheckPlanStrategyCreate'],
  ['AfterLease/CheckPlanStrategyLogEntries', 'AfterLeaseCheckPlanStrategyLog'],
  ['AfterLease/CheckPlanStrategyPageEntries', 'AfterLeaseCheckPlanStrategy'],
  ...
  ['AfterLease/RentCollectionInterestModalEntries', 'RentCollectionInterestModal'],
  ['AfterLease/RentCollectionListPageEntries', 'RentCollectionList'],
  ['AfterLease/RentCollectionListRenderEntries', 'RentCollectionListRender'],
  ...
  ['Budget/PricingBaseSetListEntries', 'BudgetPricingBaseSetList'],
  ['Budget/PricingBaseSetModalDetailEntries', 'BudgetPricingBaseSetModalDetail'],
  ['Budget/PricingBaseSetModalEditTableEntries', 'BudgetPricingBaseSetModalEditTable'],
  ...
  ['Budget/ProvisioningDataAddModalEntries', 'BudgetProvisioningDataAddModal'],
  ['Budget/ProvisioningDataEntries', 'BudgetProvisioningData'],
  ['Budget/ProvisioningImpairmentColumnsEntries', 'BudgetProvisioningImpairmentColumns'],
  ['Budget/ProvisioningImpairmentEntries', 'BudgetProvisioningImpairment'],
  ['Budget/ProvisioningParamsConfigColumnsEntries', 'BudgetProvisioningParamsConfigColumns'],
  ...
  ['BudgetManagement/PlacementPlanDetailEntries', 'BudgetManagementPlacementPlanDetail'],
  ['BudgetManagement/PlacementPlanListEntries', 'BudgetManagementPlacementPlanList'],
  ['BudgetManagement/PlacementPlanWeekDetailEntries', 'BudgetManagementPlacementPlanWeekDetail'],
  ['BudgetManagement/PlanCostEntries', 'BudgetManagementPlanCost'],
  ['BudgetManagement/PlanProfitBusinessDetailEntries', 'BudgetManagementPlanProfitBusinessDetail'],
  ['BudgetManagement/PlanProfitDetailEntries', 'BudgetManagementPlanProfitDetail'],
  ['BudgetManagement/PlanProfitListEntries', 'BudgetManagementPlanProfitList'],
  ['BudgetManagement/ProvisionForecastConfigDetailEntries', 'BudgetManagementProvisionForecastConfigDetail'],
  ['BudgetManagement/ProvisionForecastDetailEntries', 'BudgetManagementProvisionForecastDetail'],
  ['BudgetManagement/ProvisionForecastListEntries', 'BudgetManagementProvisionForecastList'],
  ...
  ['Contract/ApplicationLeaseLogEntries', 'ContractApplicationLeaseLog'],
  ['Contract/ApplicationLogDiffEntries', 'ContractApplicationLogDiff'],
  ['Contract/ApplicationLogEntries', 'ContractApplicationLog'],
  ...
  ['Contract/DepositRefundNotificationEntries', 'ContractDepositRefundNotification'],
  ...
  ['Cpm/ContractCpmCashFlowEntries', 'CpmContractCpmCashFlow'],
  ['Cpm/ContractCpmDetailEntries', 'CpmContractCpmDetail'],
  ['Cpm/ContractCpmDownPaymentEntries', 'CpmContractCpmDownPayment'],
  ['Cpm/ContractCpmListEntries', 'CpmContractCpmList'],
  ['BlackGray/WarehouseApprovalDetailEntries', 'BlackGrayWarehouseApprovalDetail'],
  ['BlackGray/WarehouseApprovalListEntries', 'BlackGrayWarehouseApprovalList'],
  ['BlackGray/WarehouseApprovalOutDetailEntries', 'BlackGrayWarehouseApprovalOutDetail'],
  ['BlackGray/WarehouseMainTaskDetailEntries', 'BlackGrayWarehouseMainTaskDetail'],
  ['BlackGray/WarehouseMainTaskListEntries', 'BlackGrayWarehouseMainTaskList'],
  ['BlackGray/WarehouseMainTaskOutDetailEntries', 'BlackGrayWarehouseMainTaskOutDetail'],
  ...
  ['CreditManage/CreditTableAccountEntries', 'CreditManageCreditTableAccount'],
  ['CreditManage/CreditTableClientEntries', 'CreditManageCreditTableClient'],
  ['CreditManage/CreditTableFinishAccountEntries', 'CreditManageCreditTableFinishAccount'],
  ['CreditManage/CreditTableFinishBatchEntries', 'CreditManageCreditTableFinishBatch'],
  ['CreditManage/CreditTableFinishEntries', 'CreditManageCreditTableFinish'],
  ['CreditManage/CreditTableGuaranteeEntries', 'CreditManageCreditTableGuarantee'],
  ['CreditManage/CreditTableLevel5CreateModalEntries', 'CreditManageCreditTableLevel5CreateModal'],
  ['CreditManage/CreditTableLevel5Entries', 'CreditManageCreditTableLevel5'],
  ['CreditManage/CreditTableMortgageEntries', 'CreditManageCreditTableMortgage'],
  ['CreditManage/CreditTableOverdueEntries', 'CreditManageCreditTableOverdue'],
  ['CreditManage/CreditTablePledgeEntries', 'CreditManageCreditTablePledge'],
  ['CreditManage/CreditTableRepaymentEntries', 'CreditManageCreditTableRepayment'],
  ['CreditManage/CreditTableTabEntries', 'CreditManageCreditTableTab'],
  ['CreditManage/CreditTableTransactionEntries', 'CreditManageCreditTableTransaction'],
  ['CreditManage/CreditTableWaitEntries', 'CreditManageCreditTableWait'],
  ['CreditManage/SearchDetailEntries', 'CreditManageSearchDetail'],
  ...
  ['Dashboard/SsoFlowEntries', 'Dashboard'],
  ['Dashboard/SsoLoginEntries', 'Dashboard'],
  ['Dashboard/WorkbenchPageEntries', 'Dashboard'],
  ['Dashboard/WorkbenchRedirectEntries', 'Dashboard'],
  ...
  ['Financial/FundDetailActualTableEntries', 'FinancialFundDetailActualTable'],
  ['Financial/FundDetailEstimateTableEntries', 'FinancialFundDetailEstimateTable'],
  ['Financial/FundActualTableEntries', 'FinancialFundActualTable'],
  ['Financial/FundDetailSchemeEntries', 'FinancialFundDetailScheme'],
  ['Financial/FundGuaranteeEntries', 'FinancialFundGuarantee'],
  ['Financial/FundListChangeModalEntries', 'FinancialFundListChangeModal'],
  ['Financial/FundListCreateModalEntries', 'FinancialFundListCreateModal'],
  ['Financial/FundListMainEntries', 'FinancialFundListMain'],
  ...
  ['Kpi/BaseSetBasePrizeRateEntries', 'KpiBaseSetBasePrizeRate'],
  ...
  ['Kpi/BaseSetProjectScaleFactorEntries', 'KpiBaseSetProjectScaleFactor'],
  ['Kpi/BaseSetProjectExtractEntries', 'KpiBaseSetProjectExtract'],
  ['Kpi/BaseSetProjectTypeFactorEntries', 'KpiBaseSetProjectTypeFactor'],
  ...
  ['Kpi/PmAssessDetailContentEntries', 'KpiPmAssessDetailContent'],
  ['Kpi/PmAssessEditModalEntries', 'KpiPmAssessEditModal'],
  ['Kpi/PmAssessListEntries', 'KpiPmAssessList'],
  ['Kpi/ProjectAllotAllocateInfoEntries', 'KpiProjectAllotAllocateInfo'],
  ...
  ['Lease/MaintainDetailEntries', 'LeaseMaintainDetail'],
  ...
  ['Project/ReviewMaterialTableEntries', 'ProjectReviewMaterialTable'],
  ...
  ['Report/OperationAnalysisEntries', 'ReportOperationAnalysis'],
  ['Report/OperationContractMonitorEntries', 'ReportOperationContractMonitor'],
  ['Report/OperationPendingEntries', 'ReportOperationPending'],
  ...
  ['Risk/MetricValueControlEntries', 'RiskMetricValueControl'],
  ['Risk/MetricValueJinKonEntries', 'RiskMetricValueJinKon'],
  ['Risk/MetricValuePageEntries', 'RiskMetricValuePage'],
  ['Risk/MetricValueTargetEntries', 'RiskMetricValueTarget'],
  ...
  ['Risk/SourceCardCalcModalEntries', 'RiskSourceCardCalcModal'],
  ['Risk/SourceCardDetailEntries', 'RiskSourceCardDetail'],
  ['Risk/SourceCardListEntries', 'RiskSourceCardList'],
