 ...
 *
 * @分类 [workbench-chart-metric-api↗](http://api-dev.zswl.cn:3011/project/11/interface/api/cat_2328)
 * @请求头 `POST /workbench/chart/list/undesirable/proj`
 * @更新时间 `2023-06-10 15:40:18`
 */
...
/**
 * 接口 [工作台-大可视化新增投放表格↗](http://api-dev.zswl.cn:3011/project/11/interface/api/12459) 的 **请求类型**
 *
 * @分类 [workbench-chart-metric-api↗](http://api-dev.zswl.cn:3011/project/11/interface/api/cat_2328)
...
/**
 * 接口 [工作台-大可视化新增投放表格↗](http://api-dev.zswl.cn:3011/project/11/interface/api/12459) 的 **返回类型**
 *
 * @分类 [workbench-chart-metric-api↗](http://api-dev.zswl.cn:3011/project/11/interface/api/cat_2328)
 * @请求头 `POST /workbench/chart/list/launch`
 * @更新时间 `2023-06-10 15:40:17`
...
/**
 * 接口 [工作台-大可视化新增评审表格↗](http://api-dev.zswl.cn:3011/project/11/interface/api/12454) 的 **请求类型**
 *
 * @分类 [workbench-chart-metric-api↗](http://api-dev.zswl.cn:3011/project/11/interface/api/cat_2328)
...
/**
 * 接口 [工作台-大可视化新增评审表格↗](http://api-dev.zswl.cn:3011/project/11/interface/api/12454) 的 **返回类型**
 *
 * @分类 [workbench-chart-metric-api↗](http://api-dev.zswl.cn:3011/project/11/interface/api/cat_2328)
 * @请求头 `POST /workbench/chart/list/review`
 * @更新时间 `2023-06-10 15:40:17`
...
/**
 * 接口 [工作台-本年\/本月新增立项列表↗](http://api-dev.zswl.cn:3011/project/11/interface/api/12969) 的 **请求类型**
 *
 * @分类 [workbench-chart-metric-api↗](http://api-dev.zswl.cn:3011/project/11/interface/api/cat_2328)
...
/**
 * 接口 [工作台-本年\/本月新增立项列表↗](http://api-dev.zswl.cn:3011/project/11/interface/api/12969) 的 **返回类型**
 *
 * @分类 [workbench-chart-metric-api↗](http://api-dev.zswl.cn:3011/project/11/interface/api/cat_2328)
 * @请求头 `POST /workbench/chart/list/year/proj`
 * @更新时间 `2023-06-10 15:40:18`
...
/**
 * 接口 [工作台-本年\/本月累计投放金额列表↗](http://api-dev.zswl.cn:3011/project/11/interface/api/12979) 的 **请求类型**
 *
 * @分类 [workbench-chart-metric-api↗](http://api-dev.zswl.cn:3011/project/11/interface/api/cat_2328)
...
/**
 * 接口 [工作台-本年\/本月累计投放金额列表↗](http://api-dev.zswl.cn:3011/project/11/interface/api/12979) 的 **返回类型**
 *
 * @分类 [workbench-chart-metric-api↗](http://api-dev.zswl.cn:3011/project/11/interface/api/cat_2328)
 * @请求头 `POST /workbench/chart/list/year/payment`
 * @更新时间 `2023-06-10 15:40:18`
