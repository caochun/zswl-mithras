...
import BaseInfo from '@/pages/kpi/projectAllot/Component/BaseInfo'
import AllocateInfo from '@/pages/kpi/projectAllot/Component/AllocateInfo'
import ExtarInfo from '@/pages/kpi/projectAllot/Component/ExtarInfo'
import BeforeAllocateInfoModal from '@/pages/kpi/projectAllot/Component/BeforeAllocateInfoModal'
import allotApi from '@/api/kpi/projectAllot/allot'
import { message } from 'antd'
import { ProcessInfoModal } from '@/components'
