...
import ReviewStore from '@/pages/project/review/detail/store'
import BaseInfo from '@/pages/project/review/detail/BaseInfo'
import QuotationScheme from '@/pages/project/review/detail/QuotationScheme'
import CashFlowStatement from '@/pages/project/review/detail/CashFlowStatement'
import DataList from '@/pages/project/review/detail/Data'
import ReviewData from '@/pages/project/review/detail/Report'
