        ...
        <Spin spinning={loading}>
          <div className={styles.tableWrap}>
            <div className={styles.childWrap}>
              {Object.keys(financeList).length > 0 && (
                <Table
                columnsFilter={'components_Financial_Debt_1'}
                        onFilter={(key,val) => saveServer('components_Financial_Debt_1',val)}
              ...
              financeList.slice(1).map((obj, i) => {
                return (
                  <div className={styles.childWrap} key={i}>
                    <Table
                columnsFilter={'components_Financial_Debt_2'}
        onFilter={(key,val) => saveServer('components_Financial_Debt_2',val)}
