...
const Lease = ({ showValue, form, detail, compareChangeList = [], isLog, isNormal }) => {
            ...
            formContent={
              <Input.Group compact>
                <Form.Item
                  ...
                  // ]}
                >
                  <Select options={options.rateType} placeholder="请选择" allowClear />
                </Form.Item>
                <Form.Item
                  name="aocRatePercent"
        ...
        >
          <FormItemContent
            ...
            formContent={
              ...
              >
                <Input suffix={<div className={styles.suffix}>%</div>} style={{ width: '305px' }} />
              </Form.Item>
            }
            value={
