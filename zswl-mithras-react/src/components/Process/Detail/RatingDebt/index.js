...
import { CustomerDebtRatDetail as DebtRat } from '@/components/Customer/DebtRatingDetailEntries'

const ProcessDetailRatingDebt = (props) => {
...
export default observer(ProcessDetailRatingDebt)
