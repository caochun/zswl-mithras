...
function Index({ store }) {
  ...
  const { displayDimensions = [] } = store.cashSearchBar.getParams()
    ...
    <>
      <div className={styles.searchWrap}>
        <div className={styles.searchBar}>
          ...
          >
            <Row>
              <CommonSearch searchStore={store.cashSearchBar} />
              ...
              <Item>
                <Button type={'primary'} onClick={store.cashSearchBar.search}>
                  查询
                </Button>
              </Item>
            </Row>
              ...
              financeList.slice(1).map((obj, i) => {
                return (
                  <div className={styles.tableCell} key={i}>
                    <Table
                      columnsFilter={'maintain_detail_Financial_Cash_2'}
                      onFilter={(key,val) => saveServer('maintain_detail_Financial_Cash_2',val)}
                      bordered
                      size={'small'}
                      pagination={false}
                      columns={[
