...
import { reportTitle } from '../ReportOperationContractMonitor'
import { saveServer } from '@/utils'

const ReportOperationContractMonitorListDrawer = ({ store }) => {
...
export default observer(ReportOperationContractMonitorListDrawer)
