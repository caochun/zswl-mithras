...
import CreateModal from './CreateModal/ContractPledgeCreateModal'
...
const ContractApplicationPledge = ({ baseStore, canEditFlag }) => {
...
export default observer(ContractApplicationPledge)
