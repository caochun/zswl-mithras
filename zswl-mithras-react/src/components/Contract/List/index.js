        ...
        <Table
          ...
          actions={[
            ...
            },
            {
              ...
              disabled:
                !(isTeamleader() || PROJ_SPONSOR_USERID === userInfo.id) &&
                ['SETTLE', 'START_RENT', 'TAKE_EFFECT'].includes(CONTRACT_STATUS),
            },
          ].filter(Boolean)}
          scroll={{
            x: 1300,
