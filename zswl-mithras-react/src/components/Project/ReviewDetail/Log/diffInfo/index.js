...
import BaseInfo from './BaseInfo/ProjectReviewLogBaseInfoDiff'
import BaoJia from './BaoJia/ProjectReviewLogQuotationDiff'
          ...
          <Collapse defaultActiveKey={[]} accordion className={styles.collapse}>
            ...
            <Panel header="文件变更日志" key="file" forceRender>
              <ChangeLogDiff
                ...
                functionCode="projreviewfilelistversioncompare"
              />
            </Panel>
          </Collapse>
        </div>
