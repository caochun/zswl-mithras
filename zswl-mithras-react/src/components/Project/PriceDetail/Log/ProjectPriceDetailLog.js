...
function ProjectPriceDetailLog({ params: { id } }) {
  ...
  return (
    <Page header={null}>
      ...
      <Table
        ...
        columnsFilter={'price_detail_log_1'}
        onFilter={(key,val) => saveServer('price_detail_log_1',val)}
        columns={[
...
export default observer(ProjectPriceDetailLog)
