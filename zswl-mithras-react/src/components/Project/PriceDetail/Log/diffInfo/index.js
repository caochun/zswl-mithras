...
import BaseInfo from './BaseInfo/ProjectPriceLogBaseInfoDiff'
import BaoJia from './BaoJia/ProjectPriceLogQuotationDiff'
...
function ProjectPriceDetailLogDiff({ params: { id }, query: { bizType } }) {
          ...
          <Collapse defaultActiveKey={[]} accordion className={styles.collapse}>
            ...
            <Panel header="文件变更日志" key="file" forceRender>
              <ChangeLogDiff
                ...
                functionCode="projpricingfilelistversioncompare"
              />
            </Panel>
          </Collapse>
        </div>
...
export default observer(ProjectPriceDetailLogDiff)
