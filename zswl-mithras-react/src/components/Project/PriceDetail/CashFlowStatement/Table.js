...
const CashFlowStatementTable = ({ tableStore }) => {
  ...
  return <Table         columnsFilter={'detail_CashFlowStatement_Table'}
  onFilter={(key,val) => saveServer('detail_CashFlowStatement_Table',val)} store={tableStore} columns={columns} />
}
