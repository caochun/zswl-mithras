...
function ProjectEstablishmentDetailLog({ params: { id } }) {
  ...
  return (
    <Page header={null}>
      <h3>版本日志</h3>
      <Table
        columnsFilter={'establishment_detail_log_idjs'}
        onFilter={(key, val) => saveServer('establishment_detail_log_idjs', val)}
        autoRequest={false}
...
export default observer(ProjectEstablishmentDetailLog)
