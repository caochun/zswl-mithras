...
import FormListItem, { toDetail } from '@/components/Project/FormListItem'
import styles from '../index.less'
import { observer } from '@zswl/admin'
import FounderSelect from '@/components/Project/FounderSelect'
...
const Factoring = ({ showValue, form, detail, isLog, compareChangeList = [] }) => {
