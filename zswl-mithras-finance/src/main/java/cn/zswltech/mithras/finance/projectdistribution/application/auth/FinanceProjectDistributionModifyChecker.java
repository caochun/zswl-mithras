package cn.zswltech.mithras.finance.projectdistribution.application.auth;
 ...
 */
@Component
public class FinanceProjectDistributionModifyChecker implements IDataAuthChecker {
    @Resource
    ...
    public boolean check(DataAuthBusinessModule businessModule, Class<? extends BaseMapper> helperMapperClass, Long keyId, Object[] args) {
        ...
        FinanceProjectDistribution financeProjectDistribution;
        if (mainData instanceof FinanceProjectDistribution) {
            financeProjectDistribution = (FinanceProjectDistribution) mainData;
        } else {
        ...
        ProcessResp processResp = processService.findRelatedProcess(String.valueOf(financeProjectDistribution.getId()), businessModule.getModelKeyList());
