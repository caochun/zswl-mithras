...
import cn.zswltech.mithras.finance.projectdistribution.mapper.FinanceProjectDistributionDeptLaunchWeightMapper;
...
public class FinanceProjectDistributionDeptLaunchWeightService extends ServiceImpl<FinanceProjectDistributionDeptLaunchWeightMapper, FinanceProjectDistributionDeptLaunchWeight> implements FinanceProjectDistributionDeptLaunchWeightApplicationService {
    ...
    public List<FinanceProjectDistributionDeptLaunchWeightInfo> queryList(Long projectDistributionId) {
        ...
        // 组装数据
        Map<Long, String> map = deptNameResolver.deptId2Name(list.stream().map(FinanceProjectDistributionDeptLaunchWeight::getWeightTarget).collect(Collectors.toSet()));
