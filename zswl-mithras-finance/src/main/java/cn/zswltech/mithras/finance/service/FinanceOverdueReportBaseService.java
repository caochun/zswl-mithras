...
import cn.zswltech.mithras.finance.mapper.finance.FinanceOverdueReportBaseMapper;
...
public class FinanceOverdueReportBaseService extends ServiceImpl<FinanceOverdueReportBaseMapper, FinanceOverdueReportBase> implements FinanceOverdueReportBaseApplicationService {
    ...
    public Long add(FinanceOverdueReportBaseAddREQ req) {
        ...
        List<CommonProcessPrepare> commonProcessPrepares = commonProcessPrepareMapper.selectList(Wrappers.<CommonProcessPrepare>lambdaQuery()
        ...
        if (ObjectUtil.isNotEmpty(commonProcessPrepares)) {
            ...
            commonProcessPrepares.forEach(commonProcessPrepareMapper::updateById);
        }
        return info.getId();
    }
