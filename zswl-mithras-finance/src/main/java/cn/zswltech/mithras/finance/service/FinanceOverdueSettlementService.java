...
import cn.zswltech.mithras.finance.enums.financeoverdue.OverdueSettlementRelationEnum;
import cn.zswltech.mithras.finance.mapper.finance.FinanceOverdueSettlementMapper;
...
import cn.zswltech.mithras.third.overduereport.infrastructure.client.handle.OverdueReportSetBatSaveHandle;
import cn.zswltech.mithras.third.overduereport.infrastructure.client.req.OverdueReportSetBatSaveReq;
import cn.zswltech.mithras.third.overduereport.infrastructure.client.rsp.OverdueReportSetBatSaveRSP;
...
public class FinanceOverdueSettlementService extends ServiceImpl<FinanceOverdueSettlementMapper, FinanceOverdueSettlement> implements FinanceOverdueSettlementApplicationService {
    ...
    public List<FinanceOverdueSettlementContractRelationRsp> contractRelation(FinanceOverdueSettlementContractRelationREQ req) {
        List<ContractBaseInfo> contractBaseInfos = contractBaseInfoMapper.selectList(Wrappers.<ContractBaseInfo>lambdaQuery()
                .in(ContractBaseInfo::getClientId, Collections.singletonList(req.getClientId()))
        ...
        Map<Long, List<CollectionBaseInfo>> contractId2Collections = collectionBaseInfoMapper.selectList(Wrappers.<CollectionBaseInfo>lambdaQuery()
