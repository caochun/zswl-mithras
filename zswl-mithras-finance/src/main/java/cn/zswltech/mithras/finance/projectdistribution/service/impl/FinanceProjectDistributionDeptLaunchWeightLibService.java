...
import cn.zswltech.mithras.finance.projectdistribution.mapper.FinanceProjectDistributionDeptLaunchWeightLibMapper;
import cn.zswltech.mithras.finance.projectdistribution.mapper.model.FinanceProjectDistribution;
import cn.zswltech.mithras.finance.projectdistribution.mapper.model.FinanceProjectDistributionDeptLaunchWeightLib;
...
public class FinanceProjectDistributionDeptLaunchWeightLibService extends ServiceImpl<FinanceProjectDistributionDeptLaunchWeightLibMapper, FinanceProjectDistributionDeptLaunchWeightLib> {
    ...
    public List<FinanceProjectDistributionDeptLaunchWeightInfo> buildDeptLaunchWeightInfoByDistributionId(Long distributionId, String version) {
        ...
        Map<Long, String> deptId2NameMap = deptNameResolver.deptId2Name(financeProjectDistributionDeptWeightLibs.stream()
