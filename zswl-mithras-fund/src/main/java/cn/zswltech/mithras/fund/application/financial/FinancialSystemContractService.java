...
import cn.zswltech.mithras.fund.domain.enums.financing.LprAdjustmentDayEnum;
...
//                .notIn(FundFinancingBaseInfo::getBusinessType, FundFinancingBizTypeEnum.BANK_ACCEPTANCE.name(), FundFinancingBizTypeEnum.COMMERCE_ACCEPTANCE.name(), FundFinancingBizTypeEnum.LETTER_OF_CREDIT.name()));
        ...
        Map<Long, List<FundFinancingRepayActual>> repayActualMap = financialSystemDataPort.getRepayActualByFinancingId(financingIdList);
        for (FundFinancingBaseInfo financingBaseInfo : financingBaseInfoList) {
            ...
            body.setORG_ID("ZSZL")
                    ...
                    .setCCY_CD("CNY")
                    .setCONTR_AMT(Optional.ofNullable(financingBaseInfo.getFinancingAmount()).map(FinancialSystemFormatUtil::toYuanWithoutSplit).orElse(null))
                    ...
                    .setCORP_PRIV_FLG("1")
                    .setLILVFDFS(FinancialSystemFormatUtil.interestRateTypeCode(financingPlan.getInterestRateType()))
            ...
            body.setDKZQRZJG(orgName)
                    ...
                    .setLILVLEIX(FinancialSystemFormatUtil.lprTypeCode(financingPlan.getLprType()))
                    .setDKDWLEIB("04")
                    .setTKFANGS("01")
