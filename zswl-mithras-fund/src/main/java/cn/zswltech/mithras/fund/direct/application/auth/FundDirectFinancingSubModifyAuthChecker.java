package cn.zswltech.mithras.fund.direct.application.auth;
 ...
 */
@Component
public class FundDirectFinancingSubModifyAuthChecker implements IDataAuthChecker {
    @Resource
    private AuthHelper authHelper;
    @Resource
    private FundDirectFinancingMainModifyAuthChecker mainChecker;
