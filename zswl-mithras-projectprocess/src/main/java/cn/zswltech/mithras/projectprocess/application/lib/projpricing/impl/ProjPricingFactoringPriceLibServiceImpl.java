...
import cn.zswltech.mithras.projectprocess.application.lib.projpricing.ProjPricingFactoringPriceLibService;
...
public class ProjPricingFactoringPriceLibServiceImpl extends ProjPricingEditionAdvice<ProjPricingFactoringPriceLibMapper, ProjPricingFactoringPriceLib> implements ProjPricingFactoringPriceLibService {
    ...
    private ProjPricingFactoringPriceRSP toRsp(ProjPricingFactoringPriceLib entity) {
        ProjPricingFactoringPriceRSP rsp = new ProjPricingFactoringPriceRSP();
        ...
        rsp.setSummary(entity.getSummary());
