...
public class ProjPricingBaseInfoFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        ...
        return new DefaultDataCompare<ProjPricingBaseInfo, ProjPricingBaseInfoLib, ProjPricingBaseInfoDetailRSP>(rsps, libMapper, handler, commonVersionMapper,"PROJ_PRICING", version);
    }
}
