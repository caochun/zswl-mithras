 ...
 * @date 2022-07-20
 */
public interface ProjEstablishFactoringPriceLibMapper extends BaseMapper<ProjEstablishFactoringPriceLib> {

    @Select("<script>" +
            "SELECT p.* FROM proj_establish_factoring_price_lib p " +
            ...
            "       </foreach>" +
            "</script>")
    List<ProjEstablishFactoringPriceLib> listNewestByProjEstablishIds(@Param("projEstablishIds") Set<Long> projEstablishIds);
}
