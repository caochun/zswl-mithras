...
public class ProjaocPriceFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        return new DefaultDataCompare<ProjEstablishAocPrice, ProjEstablishAocPriceLib, ProjEstablishAocPriceRSP>(rsps, libMapper, handler, commonVersionMapper,"PROJ_ESTABLISH", version);
    }
}