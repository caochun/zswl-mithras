 ...
 * @date 2022-07-20
 */
public interface ProjEstablishAocPriceLibMapper extends BaseMapper<ProjEstablishAocPriceLib> {
    @Select("<script>" +
            "SELECT p.* FROM proj_establish_aoc_price_lib p " +
            ...
            "       </foreach>" +
            "</script>")
    List<ProjEstablishAocPriceLib> listNewestByProjEstablishIds(@Param("projEstablishIds") Set<Long> projEstablishIds);
}
