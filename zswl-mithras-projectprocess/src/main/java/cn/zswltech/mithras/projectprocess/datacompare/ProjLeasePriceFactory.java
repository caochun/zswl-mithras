...
public class ProjLeasePriceFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        return new DefaultDataCompare<ProjEstablishLeasePrice, ProjEstablishLeasePriceLib, ProjEstablishLeasePriceRSP>(rsps, libMapper, handler, commonVersionMapper,"PROJ_ESTABLISH", version);
    }
}