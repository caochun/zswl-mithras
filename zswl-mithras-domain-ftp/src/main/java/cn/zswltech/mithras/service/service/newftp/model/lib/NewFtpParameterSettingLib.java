...
/**
 * ftp参数设定版本表
 * @TableName new_ftp_parameter_setting_lib
 */
@TableName(value ="new_ftp_parameter_setting_lib")
@Data
public class NewFtpParameterSettingLib extends NewFtpParameterSettingDraft implements ILib, Serializable {
