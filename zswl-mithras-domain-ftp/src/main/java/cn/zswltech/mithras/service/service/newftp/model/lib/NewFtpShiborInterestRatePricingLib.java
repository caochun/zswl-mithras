...
/**
 * 一年期shibor利率波动版本表
 * @TableName new_ftp_shibor_interest_rate_pricing_lib
 */
@TableName(value ="new_ftp_shibor_interest_rate_pricing_lib")
@Data
public class NewFtpShiborInterestRatePricingLib extends NewFtpShiborInterestRatePricingDraft implements ILib, Serializable {
    /**
     * 变更编号
     * 版本号
     */
