...
/**
 * 季度指导基础定价编辑区表
 * @TableName new_ftp_quarterly_base_pricing_template_lib
 */
@TableName(value ="new_ftp_quarterly_base_pricing_template_lib")
@Data
public class NewFtpQuarterlyBasePricingTemplateLib extends NewFtpQuarterlyBasePricingDraft implements ILib, Serializable {
