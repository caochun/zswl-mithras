...
/**
 * ftp指导报价扩展版本表（下半部分）
 * @TableName new_ftp_monthly_guidance_ext_lib
 */
@TableName(value ="new_ftp_monthly_guidance_ext_lib")
@Data
public class NewFtpMonthlyGuidanceExtLib extends NewFtpMonthlyGuidanceExtDraft implements ILib, Serializable {
