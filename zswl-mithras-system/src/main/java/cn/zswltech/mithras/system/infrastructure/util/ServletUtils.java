package cn.zswltech.mithras.system.infrastructure.util;
...
public class ServletUtils extends ServletUtil {
    ...
    public static String requestSource() {
        // TODO 需要考虑异步线程获取HTTP请求信息的问题
        try {
            RequestAttributes reqAttributes = RequestContextHolder.currentRequestAttributes();
            HttpServletRequest httpServletRequest = ((ServletRequestAttributes) reqAttributes).getRequest();
