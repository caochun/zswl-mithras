...
import cn.zswltech.mithras.system.infrastructure.enums.BusinessStatus;
import cn.zswltech.mithras.system.audit.event.OperLogEvent;
import cn.zswltech.mithras.system.infrastructure.util.JsonUtils;
import cn.zswltech.mithras.system.infrastructure.util.ServletUtils;
import cn.zswltech.mithras.foundation.util.SpringUtils;
...
import cn.zswltech.mithras.system.infrastructure.enums.HttpMethod;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            operLog.setOperUrl(StringUtils.substring(ServletUtils.getRequest().getRequestURI(), 0, 1000));
