package cn.zswltech.mithras.system.user;
...
import cn.zswltech.mithras.service.service.ContractInfoResolver;
import cn.zswltech.mithras.service.service.ContractNameResolver;
 ...
 */
@Service
public class Id2NameService implements UserNameResolver, DeptNameResolver {
    @Resource
    ...
    @Resource
    private ClientDeptResolver clientDeptResolver;
    @Resource
    private ContractNameResolver contractNameResolver;
    @Resource
    private ContractInfoResolver contractInfoResolver;
    ...
    public Map<Long, ClientInfo> clientId2CLient(Collection<Long> clientIds) {
        return clientInfoResolver.clientId2Client(clientIds);
    }
    ...
    public Map<Long, String> contractId2Name(Collection<Long> ids) {
        return contractNameResolver.contractId2Name(ids);
    }

    public Map<Long, String> receiptId2Name(Collection<Long> ids) {
        return contractNameResolver.receiptId2Name(ids);
    }

    public Map<Long, ContractInfo> contractId2Info(Collection<Long> ids) {
        return contractInfoResolver.contractId2Info(ids);
    }

    public Map<Long, Long> clientId2DeptId(Collection<Long> clientIds) {
        return clientDeptResolver.clientId2DeptId(clientIds);
    }
}
