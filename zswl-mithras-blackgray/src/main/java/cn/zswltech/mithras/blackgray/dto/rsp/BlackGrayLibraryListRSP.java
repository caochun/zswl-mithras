...
public class BlackGrayLibraryListRSP {
    ...
    public String getRemark() {
        ...
        return EnterpriseRemarkUtil.getEnterpriseRemark(enterpriseName, unifiedSocialCreditCode, BusinessType.valueOf(businessType));
    }
}
