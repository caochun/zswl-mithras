...
public enum BusinessMaterialsDocNameEnum {
    BUSINESS_LESSEE_BASIC("承租人基础资料清单.docx","归档-归档资料模板","基础资料清单", "FILING_BUSINESS_LESSEE_CLIENT"),
    BUSINESS_ENT_GUARANTOR_BASIC("法人保证人基础资料清单.docx","归档-归档资料模板","基础资料清单","FILING_BUSINESS_ENT_CLIENT"),
    BUSINESS_IND_GUARANTOR_BASIC("自然人保证人基础资料清单.docx","归档-归档资料模板","基础资料清单","FILING_BUSINESS_IND_CLIENT"),
    BUSINESS_CONTRACT("合同资料清单.docx","归档-归档资料模板","合同资料清单","FILING_BUSINESS_PAYMENT"),
    BUSINESS_LEASEHOLD("租赁物资料清单.docx","归档-归档资料模板","租赁物资料清单","FILING_BUSINESS_LEASEHOLD"),
    BUSINESS_COLLATERALIZATION("抵质押物资料清单.docx","归档-归档资料模板","抵质押物资料清单","FILING_BUSINESS_COLLATERALIZATION"),
    BUSINESS_INNER_OPERATION("内部操作资料清单.docx","归档-归档资料模板","内部操作清单","FILING_BUSINESS_INNER_OPERATION"),
