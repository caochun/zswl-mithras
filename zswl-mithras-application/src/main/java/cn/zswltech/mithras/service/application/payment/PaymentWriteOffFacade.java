...
public class PaymentWriteOffFacade implements PaymentWriteOffApplicationService {
    ...
    @Deprecated
    @Override
    @DataAuthCheck(checkerClass = PaymentWriteOffAuthChecker.class, businessModule = "PAYMENT")
    ...
    @Override
    @DataAuthCheck(checkerClass = PaymentActualDetailRemoveAuthChecker.class, businessModule = "PAYMENT", keyFieldName = "id", paramType = DataAuthCheck.ParamType.OBJECT)
    ...
    @Override
    @DataAuthCheck(checkerClass = PaymentActualDetailOperationAuthChecker.class, businessModule = "PAYMENT", keyFieldName = "paymentId", paramType = DataAuthCheck.ParamType.OBJECT)
