...
import cn.zswltech.mithras.customer.application.client.api.CorpShareholderInfoApplicationService;
 ...
 */
@Service
public class CorpShareholderInfoFacade implements CorpShareholderInfoApplicationService {
    @Resource
...
//    @DataAuthCheck(keyFieldName = "clientId", checkerClass = ClientAddSubAuthCheckerNew.class, businessModule = "CLIENT")
    ...
    @Override
//    @DataAuthCheck(keyFieldName = "id", checkerClass = ClientModifySubAuthCheckerNew.class, businessModule = "CLIENT", mapperClass = CorpShareholderInfoMapper.class)
    ...
    @Override
//    @DataAuthCheck(keyFieldName = "id", checkerClass = ClientRemoveSubAuthCheckerNew.class, businessModule = "CLIENT", mapperClass = CorpShareholderInfoMapper.class)
