 ...
 */
@Component
public class WzBaoLiTransferRegisterProtocolRender extends AbstractContractRender<ContractBaseInfo> {


    @Override
    public String render(OutputStream outputStream, ContractBaseInfo baseInfo) throws Exception {
        //浙商租【2023】保理字第(B-0008)号


        String filename = "4-应收账款转让登记协议.docx";
