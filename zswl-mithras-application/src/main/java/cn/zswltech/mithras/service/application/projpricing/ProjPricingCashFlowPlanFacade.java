...
@Slf4j
@Service
public class ProjPricingCashFlowPlanFacade implements ProjPricingCashFlowPlanApplicationService {
...
//        }
    ...
    @DataAuthCheck(keyFieldName = "id", checkerClass = CommonAddSubAuthCheckerNew.class, businessModule = "PROJ_PRICING")
    @Override
