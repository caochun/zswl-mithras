...
import cn.zswltech.mithras.credit.application.groupcredit.establish.service.impl.GroupCreditEstablishService;
...
import static cn.zswltech.mithras.customer.domain.enums.client.ClientStatus.NEW;
...
public class ClientService extends ServiceImpl<ClientMapper, Client> implements FlowEndEventProcessor,
        ClientRiskExposureResolver, ClientMessageNoticeJobService, ClientFocusOpinionSyncService,
        ClientProvinceQueryService {
    ...
    public Map<Long, ClientBusinessHistoryBO> compareBusiness(List<Long> clientIds) {
        ...
        clients.stream().filter(client -> ClientType.CORPORATION.name().equals(client.getClientType())).forEach(client -> {
            ...
            if (mithrasBaseInfo != null) {
                ...
                rsp.setTycShareHolderInfo(BeanUtil.copyToList(shareholderInfos, cn.zswltech.mithras.customer.service.model.MithrasShareholderInfo.class));
