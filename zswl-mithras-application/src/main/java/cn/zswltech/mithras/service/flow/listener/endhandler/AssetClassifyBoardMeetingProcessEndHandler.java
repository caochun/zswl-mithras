 ...
 */
@Component
public class AssetClassifyBoardMeetingProcessEndHandler extends AbstractProcessEndHandler {
    @Resource
    private AssetClassifyProcessService assetClassifyProcessService;

    @Override
    public boolean needHandle(ProcessEndContext endContext) {
        return Objects.equals(endContext.getModelKey(), ProcessModelTypeEnum.AssetClassifyBoardMeetingFlow.name());
    }

    @Override
    public void handle(ProcessEndContext endContext) {
        assetClassifyProcessService.endBoardMeeting(endContext);
    }
}
