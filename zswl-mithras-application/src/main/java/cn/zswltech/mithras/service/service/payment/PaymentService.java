...
import cn.zswltech.mithras.payment.application.PaymentStatusUpdatePort;
...
import cn.zswltech.mithras.projlifecycle.application.ProjectLifecycleEventService;
...
@Slf4j
@Service
public class PaymentService implements FlowEndEventProcessor, PaymentStatusUpdatePort {
    @Resource
    ...
    @Override
    public boolean hasRelatedProcess(Long paymentId) {
        return ObjectUtil.isNotNull(findRelatedProcess(paymentId));
    }
