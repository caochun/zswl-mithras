...
import cn.zswltech.mithras.credit.application.groupcredit.establish.service.impl.GroupCreditEstablishUpdateAdvice;
        ...
        if (CollectionUtil.isNotEmpty(mList)) {
            ...
            mList.forEach(item -> {
                ...
                if (Objects.equals(item.getMaterialSubType(), CorporationClientMaterialSubTypeEnum.LEASE_APPLICATION.name())) {
                    businessModule = "GROUP_CREDIT_ESTABLISH";
                    materialType = GroupCreditEstablishMaterialsEnum.PROJ_INFORMATION.name();
                } else {
                    businessModule = "GROUP_CREDIT_ESTABLISH_CLIENT";
