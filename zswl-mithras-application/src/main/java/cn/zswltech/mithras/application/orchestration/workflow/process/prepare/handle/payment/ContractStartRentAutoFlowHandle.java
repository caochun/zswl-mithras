package cn.zswltech.mithras.application.orchestration.workflow.process.prepare.handle.payment;
...
public class ContractStartRentAutoFlowHandle extends AbstractFlowCommitHandle {
    ...
    private static final String CONTRACT_AUTO_FLOW_TARGET_PAYMENT_KEY = "targetPaymentId";
    ...
    public String commit(CommonProcessPrepare prepare) {
        PaymentBaseInfo paymentBaseInfo = paymentBaseInfoMapper.selectById(Long.valueOf(prepare.getBusinessId()));
        ...
        varMap.put(CONTRACT_AUTO_FLOW_TARGET_PAYMENT_KEY, paymentBaseInfo.getId());
