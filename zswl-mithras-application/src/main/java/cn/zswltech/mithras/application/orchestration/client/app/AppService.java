package cn.zswltech.mithras.application.orchestration.client.app;
...
import cn.zswltech.mithras.customer.mobile.enums.VisitDownloadTaskStatusEnum;
...
import cn.zswltech.mithras.customer.mobile.persistence.mapper.AppContractSignMapper;
import cn.zswltech.mithras.customer.mobile.persistence.mapper.VisitDownloadTaskRecordMapper;
...
import cn.zswltech.mithras.customer.mobile.persistence.model.VisitDownloadTaskRecord;
...
public class AppService extends ServiceImpl<VisitRecordMapper, VisitRecord> {
    ...
    public void checkInUpload(AppCheckInREQ req) {
        if (Objects.isNull(req.getClientId())) {
            ...
            R<CorpCommerceInfoAddREQ> r = SpringUtil.getBean(ClientApplicationService.class).addCorporation(addREQ);
            if (!r.isSuccess()) {
