package cn.zswltech.mithras.application.adapter.ftp;
...
@Service
public class FtpQuarterlyGuidanceApplicationAdapter implements FtpQuarterlyGuidanceApplicationService {
    ...
    public void submit(Long id) {
        ...
        ProcessResp relatedProcess = quarterlyGuidanceService.findRelatedProcess(id);
