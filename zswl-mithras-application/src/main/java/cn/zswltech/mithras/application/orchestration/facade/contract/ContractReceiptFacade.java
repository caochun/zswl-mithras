...
public class ContractReceiptFacade implements ContractReceiptApplicationService {
    ...
    @Override
    @DataAuthCheck(keyFieldName = "receiptId", checkerClass = ContractBaseRemoveSubAuthChecker.class, businessModule = "CONTRACT", mapperClass = ContractReceiptMapper.class)
