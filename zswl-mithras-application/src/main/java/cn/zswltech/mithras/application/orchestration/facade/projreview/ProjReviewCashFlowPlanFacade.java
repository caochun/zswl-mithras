...
import cn.zswltech.mithras.application.orchestration.projectprocess.projreview.ProjReviewCashFlowQuotationProposalService;
...
@Slf4j
@Service
public class ProjReviewCashFlowPlanFacade implements ProjReviewCashFlowPlanApplicationService {
...
//        }
    ...
    @DataAuthCheck(keyFieldName = "id", checkerClass = CommonAddSubAuthCheckerNew.class, businessModule = "PROJ_REVIEW")
    @Override
