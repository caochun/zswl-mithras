...
import cn.zswltech.mithras.fund.application.credit.convert.FundGuaranteeAgencyConverter;
...
import cn.zswltech.mithras.fund.mapper.FundGuaranteeAgencyMapper;
...
public class FundGuaranteeAgencyService extends ServiceImpl<FundGuaranteeAgencyMapper, FundGuaranteeAgency> {
    ...
    public Long addAndSync(FundGuaranteeAgencyAddREQ req) {
        ...
        FundGuaranteeAgency toBeInsert = tycInfo2Entity(mithrasBaseInfo);
    ...
    private FundGuaranteeAgency tycInfo2Entity(MithrasBaseInfo mithrasBaseInfo) {
        return BeanUtil.copyProperties(mithrasBaseInfo, FundGuaranteeAgency.class);
    }
