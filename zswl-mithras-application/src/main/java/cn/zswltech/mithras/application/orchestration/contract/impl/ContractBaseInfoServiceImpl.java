...
import cn.zswltech.mithras.contract.dto.persistence.ContractRentLastTimeDTO;
...
//        }
    ...
    @Override
    //计算客户风险敞口
    public Long getStockRiskExposure(Long clientId, Long mainId, String module) {
        return getStockRiskExposure(clientId, mainId, module, null);
    }

    @Override
    public Long getStockRiskExposure(Long clientId, Long mainId, String module, LocalDate confirmDate) {
        if (isNull(clientId)) {
            return 0L;
        }
        ...
        if (ObjectUtil.isNotEmpty(module)) {
            switch (BusinessModuleEnum.of(module)) {
                case PROJ_REVIEW:
