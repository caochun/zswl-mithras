package cn.zswltech.mithras.application.orchestration.workflow.flow.dynamicform.projpricing;
 ...
 */
@Component
public class ShowPricingVotingResultHandler implements DynamicFormHandler {
    @Resource
    ...
    public void collect(TaskDetailRSP rsp) {
        ...
        List<VoteFormRSP.VoteRSP> voteRSPList = processApiService.queryVoteResult(rsp.getProcessInstanceId(), "userTask_priceCommittee")
                .stream()
                // 一人一票 去重
    ...
    public FlowDynamicFormEnum getType() {
        return FlowDynamicFormEnum.projReview_pricingShowVoteResult;
    }
}
