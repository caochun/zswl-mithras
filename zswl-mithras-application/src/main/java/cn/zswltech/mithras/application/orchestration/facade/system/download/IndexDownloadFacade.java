package cn.zswltech.mithras.application.orchestration.facade.system.download;
...
import cn.zswltech.mithras.afterlease.controller.AfterLeaseCheckClientController;
import cn.zswltech.mithras.afterlease.controller.AfterLeaseCheckPlanBaseController;
import cn.zswltech.mithras.application.orchestration.facade.capital.BusinessFlowFacade;
import cn.zswltech.mithras.application.orchestration.facade.client.ClientFacade;
import cn.zswltech.mithras.collection.controller.CollectionFlowCenterController;
import cn.zswltech.mithras.application.orchestration.facade.contract.ContractBaseInfoFacade;
import cn.zswltech.mithras.workflow.flow.ProcessApplicationService;
import cn.zswltech.mithras.application.orchestration.workflow.flow.TaskFacade;
import cn.zswltech.mithras.ftp.oldftp.controller.FtpInterestController;
import cn.zswltech.mithras.application.orchestration.facade.fund.FundCreditFacade;
import cn.zswltech.mithras.application.orchestration.facade.fund.FundGuaranteeAgencyFacade;
import cn.zswltech.mithras.application.orchestration.facade.fund.FundOrganizationFacade;
import cn.zswltech.mithras.application.orchestration.facade.fund.financing.FundFinancingFacade;
import cn.zswltech.mithras.application.orchestration.facade.fund.receiptrepay.FundReceiptRepayBaseInfoFacade;
...
import cn.zswltech.mithras.payment.enums.PaymentFlowItemEnum;
...
import cn.zswltech.mithras.application.orchestration.facade.fund.direct.FundDirectFinancingBaseInfoFacade;
...
import cn.zswltech.mithras.contract.overdue.controller.LitigationController;
import cn.zswltech.mithras.contract.overdue.controller.CollectionController;
import cn.zswltech.mithras.contract.overdue.controller.docprinting.DocPrintingController;
...
public class IndexDownloadFacade implements IndexDownloadApplicationService {
    ...
    private final static Map<BusinessModuleEnum, Triple<Class<?>, String, List<String>>/*ControllerClass,Method, ignoredFields*/> MAP = initIndexMap();

    private static Map<BusinessModuleEnum, Triple<Class<?>, String, List<String>>> initIndexMap() {
        Map<BusinessModuleEnum, Triple<Class<?>, String, List<String>>> map = new EnumMap<>(BusinessModuleEnum.class);
        map.put(BusinessModuleEnum.CLIENT, Triple.of(ClientFacade.class, "newList", of("id")));
        map.put(BusinessModuleEnum.PROJ_ESTABLISH, Triple.of(ProjEstablishBaseInfoFacade.class, "list", of("")));
        map.put(BusinessModuleEnum.PROJ_REVIEW, Triple.of(ProjReviewBaseInfoFacade.class, "list", of()));
        map.put(BusinessModuleEnum.PROJ_PRICING, Triple.of(ProjPricingBaseInfoFacade.class, "list", of()));
        map.put(BusinessModuleEnum.CONTRACT, Triple.of(ContractBaseInfoFacade.class, "list", of()));
        map.put(BusinessModuleEnum.FUND_ORGANIZATION, Triple.of(FundOrganizationFacade.class, "list", of()));
        map.put(FUND_CREDIT, Triple.of(FundCreditFacade.class, "list", of()));
        map.put(FUND_CREDIT_LIMIT, Triple.of(FundCreditFacade.class, "limitDetail", of()));
        map.put(FUND_GUARANTEE_AGENCY_LIMIT, Triple.of(FundGuaranteeAgencyFacade.class, "limitDetail", of()));
        map.put(FUND_FINANCING, Triple.of(FundFinancingFacade.class, "pageList", of()));
        map.put(FUND_DIRECT_FINANCING, Triple.of(FundDirectFinancingBaseInfoFacade.class, "list", of()));
        map.put(BUSINESS_FLOW_PROJ_PAY, Triple.of(CollectionFlowCenterController.class, "paymentList", of()));
        map.put(BUSINESS_FLOW_PROJ_COLLECT, Triple.of(CollectionFlowCenterController.class, "collectionList", of()));
        map.put(BUSINESS_FLOW_FINANCIAL_PAY, Triple.of(BusinessFlowFacade.class, "selectList", of()));
        map.put(BUSINESS_FLOW_FINANCIAL_COLLECT, Triple.of(BusinessFlowFacade.class, "selectList", of()));
        map.put(ACCOUNT_BALANCE, Triple.of(FundLiquidityBaseController.class, "accountBalanceList", of()));
        map.put(ACCOUNT_SETTING, Triple.of(FundLiquidityBaseController.class, "accountSettingList", of()));
        map.put(LIQUIDITY_BOARD, Triple.of(FundLiquidityIndexController.class, "manageBoard", of()));
        map.put(LIQUIDITY_MISMATCH, Triple.of(FundLiquidityIndexController.class, "manageMismatch", of()));
        map.put(LIQUIDITY_RENT_INCOME, Triple.of(FundLiquidityIndexController.class, "manageRentIncome", of()));
        map.put(LIQUIDITY_REPAY, Triple.of(FundLiquidityIndexController.class, "manageRepay", of()));
        map.put(FUND_TRANSFER, Triple.of(FundTransferController.class, "list", of()));
        map.put(BusinessModuleEnum.FUND_RECEIPT_REPAY, Triple.of(FundReceiptRepayBaseInfoFacade.class, "list", of()));
        map.put(BusinessModuleEnum.MY_PROCESS_RECEIVED_AUDITED, Triple.of(TaskFacade.class, "myReceiveDoneList", of()));
        map.put(BusinessModuleEnum.MY_PROCESS_PROCESS_QUERY, Triple.of(ProcessApplicationService.class, "list", of()));
        map.put(BusinessModuleEnum.AFTER_LEASE_CHECK_PLAN, Triple.of(AfterLeaseCheckPlanBaseController.class, "afterLeaseAssetStrategys", of()));
        map.put(NEW_AFTER_LEASE_CHECK_PLAN_LEDGER, Triple.of(AfterLeaseCheckClientController.class, "queryCheckPlanLedgerList", of()));
        map.put(BusinessModuleEnum.FTP_INTEREST, Triple.of(FtpInterestController.class, "pageList", of()));
        map.put(BusinessModuleEnum.NEW_AFTER_LEASE_CHECK_PLAN, Triple.of(AfterLeaseCheckPlanBaseController.class, "listCheckPlanWithPage", of()));
        map.put(BusinessModuleEnum.OVERDUE_COLLECTION, Triple.of(CollectionController.class, "overdueCollectionList", of()));
        map.put(BusinessModuleEnum.LITIGATION_REGISTRATION, Triple.of(LitigationController.class, "pageList", of()));
        map.put(BusinessModuleEnum.DOC_PRINTING, Triple.of(DocPrintingController.class, "pageList", of()));
        return map;
    }
    @Autowired
