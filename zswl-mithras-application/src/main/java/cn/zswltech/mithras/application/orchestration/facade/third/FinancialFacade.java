package cn.zswltech.mithras.application.orchestration.facade.third;
...
import cn.zswltech.mithras.application.orchestration.third.financial.impl.FinancialServiceImpl;
...
@Service
@Slf4j
public class FinancialFacade implements FinancialApplicationService {
    @Resource
