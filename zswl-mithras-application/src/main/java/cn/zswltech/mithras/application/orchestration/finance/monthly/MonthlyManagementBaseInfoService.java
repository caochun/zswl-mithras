package cn.zswltech.mithras.application.orchestration.finance.monthly;
...
import cn.zswltech.mithras.finance.monthly.mapper.FundsDailyCostMapper;
...
import cn.zswltech.mithras.finance.monthly.mapper.MonthlyUserRecordMapper;
            ...
            case AIR:
                ...
                if (Objects.equals(airRecord.getIsConfirmed(), YesOrNoNumberEnum.YES.getCode())
                    ...
                    try {
                        ...
                        getBean(FinancialApplicationService.class).withdraw(Collections.singletonList(withdrawReq));
                    } catch (Exception e) {
