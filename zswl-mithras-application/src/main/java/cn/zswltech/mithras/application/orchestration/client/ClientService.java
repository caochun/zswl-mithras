...
import cn.zswltech.mithras.customer.application.client.ClientChangeCheckService;
...
import cn.zswltech.mithras.afterlease.enums.AuthCheckSourceSceneEnum;
...
import static cn.zswltech.mithras.foundation.enums.JobEnum.*;
import static cn.zswltech.mithras.customer.enums.client.ClientStatus.NEW;
import static cn.zswltech.mithras.foundation.util.Const.*;
...
public class ClientService extends ServiceImpl<ClientMapper, Client> implements FlowEndEventProcessor,
        ...
        ClientProvinceQueryService, ClientOccupyGuard {
    ...
    public Map<Long, ClientBusinessHistoryBO> compareBusiness(List<Long> clientIds) {
        ...
        clients.stream().filter(client -> ClientType.CORPORATION.name().equals(client.getClientType())).forEach(client -> {
            ...
            if (mithrasBaseInfo != null) {
                ...
                rsp.setTycShareHolderInfo(BeanUtil.copyToList(shareholderInfos, cn.zswltech.mithras.customer.application.client.dto.MithrasShareholderInfo.class));
