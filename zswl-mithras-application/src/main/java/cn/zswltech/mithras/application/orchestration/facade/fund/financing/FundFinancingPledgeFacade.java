...
public class FundFinancingPledgeFacade implements FundFinancingPledgeApplicationService {
    ...
    @DataAuthCheck(keyFieldName = "id", checkerClass = FundFinancingSubModifyAuthChecker.class, businessModule = "FUND_FINANCING", mapperClass = FundFinancingPledgeInfoMapper.class)
    @Override
    ...
    @DataAuthCheck(keyFieldName = "pledgeId", checkerClass = FundFinancingSubModifyAuthChecker.class, businessModule = "FUND_FINANCING", mapperClass = FundFinancingPledgeInfoMapper.class)
    @Override
