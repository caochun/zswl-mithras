package cn.zswltech.mithras.application.orchestration.adapter.margin.job;
...
import cn.zswltech.mithras.afterlease.enums.RentCollectionIndexPaymentState;
...
public class DepositWriteOffJobPortAdapter implements DepositWriteOffJobPort {
    ...
    private void autoStartProcess(ContractRetreatInfo contractRetreatInfo, ContractBaseInfo contractBaseInfo) {
        ...
        List<OrgDO> userDeptList = userDeptResolver.userDeptList(contractBaseInfo.getProjSponsorUserId());
