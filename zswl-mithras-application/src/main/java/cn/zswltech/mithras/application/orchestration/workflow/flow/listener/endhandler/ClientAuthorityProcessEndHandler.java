 ...
 */
@Component
public class ClientAuthorityProcessEndHandler extends AbstractProcessEndHandler {
    ...
    public boolean needHandle(ProcessEndContext endContext) {
        return equalsAny(endContext.getModelKey(), ClientAuthorityCreateFlow.name(), ClientAuthorityModifyFlow.name());
    }

    @Override
    public void handle(ProcessEndContext endContext) {
        clientAuthorityService.processEnd(Long.valueOf(endContext.getBusinessKey()), endContext.getEndType(), Long.valueOf(endContext.getStartUserId()), endContext.getProcessInstanceId(), endContext.getModelKey());
    }
