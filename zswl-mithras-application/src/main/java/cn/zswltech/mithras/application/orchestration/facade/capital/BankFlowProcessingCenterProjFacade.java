 ...
 */
@Service
public class BankFlowProcessingCenterProjFacade implements BankFlowProcessingCenterProjApplicationService {


    private static final Logger log = LoggerFactory.getLogger(BankFlowProcessingCenterProjFacade.class);
    @Resource
