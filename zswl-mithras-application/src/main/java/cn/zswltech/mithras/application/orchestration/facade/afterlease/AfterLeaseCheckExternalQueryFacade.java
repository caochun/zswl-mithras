...
import cn.zswltech.mithras.afterlease.model.NewAfterLeaseCheckExternalQueryClientInfoLib;
...
import cn.zswltech.mithras.afterlease.application.lib.AfterLeaseCheckExternalQueryLibService;
import cn.zswltech.mithras.afterlease.application.lib.handler.impl.AfterLeaseCheckExternalQueryClientInfoLibHandler;
import cn.zswltech.mithras.afterlease.application.lib.handler.impl.AfterLeaseCheckExternalQueryLibHandler;
...
public class AfterLeaseCheckExternalQueryFacade implements AfterLeaseCheckExternalQueryApplicationService {
    ...
    @DataAuthCheck(
            ...
            businessModule = "NEW_AFTER_LEASE_CHECK_EXTERNAL_QUERY"
    )
