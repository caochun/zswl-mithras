...
import cn.zswltech.mithras.customer.versioning.CorpRelatedEnterpriseLibService;
 ...
 */
@Service
public class CorpRelatedEnterpriseFacade implements CorpRelatedEnterpriseApplicationService {
    @Resource
...
//    @DataAuthCheck(keyFieldName = "clientId", checkerClass = ClientAddSubAuthCheckerNew.class, businessModule = "CLIENT")
    ...
    @Override
//    @DataAuthCheck(keyFieldName = "id", checkerClass = ClientModifySubAuthCheckerNew.class, businessModule = "CLIENT", mapperClass =
//            CorpRelatedEnterpriseMapper.class)
    ...
    @Override
    @SneakyThrows
//    @DataAuthCheck(keyFieldName = "id", checkerClass = ClientRemoveSubAuthCheckerNew.class, businessModule = "CLIENT", mapperClass = CorpRelatedEnterpriseMapper.class)
