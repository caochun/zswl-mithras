...
public class FundFinancingPayAccountFacade implements FundFinancingPayAccountApplicationService {
    ...
    @DataAuthCheck(keyFieldName = "id", checkerClass = FundFinancingSubModifyAuthChecker.class, businessModule = "FUND_FINANCING", mapperClass = FundFinancingPayAccountMapper.class)
    @Override
    @Transactional(rollbackFor = Throwable.class)
