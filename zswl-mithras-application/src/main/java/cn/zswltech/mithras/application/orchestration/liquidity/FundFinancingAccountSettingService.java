...
import cn.zswltech.mithras.liquidity.persistence.mapper.FundFinancingAccountSettingMapper;
...
public class FundFinancingAccountSettingService extends ServiceImpl<FundFinancingAccountSettingMapper, FundFinancingAccountSetting> {
    ...
    @Resource
    private AccountSettingListQueryMapper accountSettingListQueryMapper;
    @Resource
    ...
    public List<AccountSettingListRSP> accountSettingList(AccountSettingListREQ req) {
        ...
        List<AccountSettingListResultDTO> resultList = accountSettingListQueryMapper.queryList(query);
