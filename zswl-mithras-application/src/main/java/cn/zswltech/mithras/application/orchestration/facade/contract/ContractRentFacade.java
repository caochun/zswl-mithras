...
import cn.zswltech.mithras.contract.application.auth.ContractRentActualAuthChecker;
...
import cn.zswltech.mithras.contract.versioning.service.ContractRentEstimateLibService;
...
@Slf4j
@Service
public class ContractRentFacade implements ContractRentApplicationService {
    @Resource
    ...
    //    @DataAuthCheck(keyFieldName = "id", checkerClass = ContractBaseAddSubAuthChecker.class, businessModule = "CONTRACT")
    @Override
    ...
    @DataAuthCheck(keyFieldName = "contractId", checkerClass = ContractRentActualAuthChecker.class, businessModule = "CONTRACT")
    @Override
