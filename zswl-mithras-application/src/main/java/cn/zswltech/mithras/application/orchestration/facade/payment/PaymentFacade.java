...
import cn.zswltech.mithras.payment.application.checker.PaymentAddAuthChecker;
import cn.zswltech.mithras.payment.application.checker.PaymentDisableAuthChecker;
...
import cn.zswltech.mithras.application.orchestration.payment.*;
...
public class PaymentFacade implements PaymentApplicationService {
    ...
    @Override
    @DataAuthCheck(checkerClass = PaymentAddAuthChecker.class, businessModule = "PAYMENT")
    ...
    @DataAuthCheck(keyFieldName = "id", checkerClass = PaymentModifyAuthChecker.class, businessModule = "PAYMENT")
    ...
    @Override
    @DataAuthCheck(keyFieldName = "ids", checkerClass = PaymentDisableAuthChecker.class, businessModule = "PAYMENT")
