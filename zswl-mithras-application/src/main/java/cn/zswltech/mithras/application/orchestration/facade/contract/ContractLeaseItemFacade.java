...
import cn.zswltech.mithras.contract.application.auth.ContractLeaseItemAuthChecker;
...
@Slf4j
@Service
public class ContractLeaseItemFacade implements ContractLeaseItemApplicationService {
    @Resource
    ...
    @DataAuthCheck(keyFieldName = "contractId", checkerClass = ContractLeaseItemAuthChecker.class, businessModule = "CONTRACT")
    @Override
