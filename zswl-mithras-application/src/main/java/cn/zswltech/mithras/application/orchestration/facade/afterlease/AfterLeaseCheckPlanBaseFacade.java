...
import cn.zswltech.mithras.afterlease.application.auth.AfterLeaseCheckPlanAddMainChecker;
...
public class AfterLeaseCheckPlanBaseFacade implements AfterLeaseCheckPlanBaseApplicationService {
    ...
    @DataAuthCheck(keyFieldName = "id", checkerClass = AfterLeaseCheckPlanModifyMainChecker.class, paramType = DataAuthCheck.ParamType.OBJECT, businessModule = "NEW_AFTER_LEASE_CHECK_PLAN")
    @Override
    ...
    @DataAuthCheck(checkerClass = AfterLeaseCheckPlanAddMainChecker.class, paramType = DataAuthCheck.ParamType.NO, businessModule = "NEW_AFTER_LEASE_CHECK_PLAN")
    @Override
