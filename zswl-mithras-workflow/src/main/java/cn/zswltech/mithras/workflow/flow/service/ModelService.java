package cn.zswltech.mithras.workflow.flow.service;
...
import cn.zswltech.mithras.workflow.flow.convert.FlowModelConvert;
...
//        modelDetailRSP.setBpmnXml(cleanCData(new String(bs)));
    ...
    public ModelConfigRSP modelConfig() {
        ...
        // 岗位
        List<ModelConfigRSP.SelectOption> jobOptions = Stream.of(JobEnum.values())
                .map(e -> new ModelConfigRSP.SelectOption(e.display(), e.name()))
