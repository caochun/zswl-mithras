...
import cn.zswltech.mithras.budget.mapper.EclExecutePredictRecordMapper;
...
public class EclExecutePredictRecordService extends ServiceImpl<EclExecutePredictRecordMapper, EclExecutePredictRecord> implements EclExecutePredictRecordApplicationService {
    ...
    public void add(EclExecutePredictRecordAddREQ req) {
        ...
        EclExecutePredictBaseInfo eclExecutePredictBaseInfo = eclExecutePredictBaseInfoService.getById(req.getExecutePredictId());
        //检验是否重复
        ...
        //调用计算
        eclExecutePredictBaseInfoService.calculation(info.getExecutePredictId(), Collections.singletonList(info.getId()));
    }
    ...
    public void importFile(EclExecutePredictRecordImportREQ req) {
        ...
        //调用计算
        eclExecutePredictBaseInfoService.calculation(req.getExecutePredictId(), records.stream().map(EclExecutePredictRecord::getId).collect(Collectors.toList()));
    ...
    private void checkPredict(Long executePredictId) {
        EclExecutePredictBaseInfo eclExecutePredictBaseInfo = eclExecutePredictBaseInfoService.getById(executePredictId);
    ...
    public void modify(EclExecutePredictRecordModifyREQ req) {
        ...
        //调用计算
        eclExecutePredictBaseInfoService.calculation(originalInfo.getExecutePredictId(), Collections.singletonList(originalInfo.getId()));
    }
    ...
    @Override
    public void saveRecords(List<EclExecutePredictRecord> records) {
        this.saveBatch(records);
    }

    @Override
    public List<EclExecutePredictRecord> listByExecutePredictId(Long executePredictId, List<Long> recordIds) {
        return this.list(Wrappers.<EclExecutePredictRecord>lambdaQuery()
                .eq(EclExecutePredictRecord::getExecutePredictId, executePredictId)
                .in(ObjectUtil.isNotEmpty(recordIds), EclExecutePredictRecord::getId, recordIds));
    }

    @Override
    public void updateRecords(List<EclExecutePredictRecord> records) {
