 ...
 */
@Service
public class ContractAccountZRHKLibHandler extends AbstractContractAccountLibHandler {


    @Override
    public ContractLibModelEnum getSubModule() {
        return ContractLibModelEnum.BANK_ACCOUNT_ZRHK;
    }
    ...
    public ContractAccountUseEnum getAccountUseEnum() {
        return ContractAccountUseEnum.ZRHK;
    }
}
