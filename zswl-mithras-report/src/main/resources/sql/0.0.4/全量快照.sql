# 流程快照表
CREATE TABLE `cr_account_full_snap` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-账户表（全量快照）';

CREATE TABLE `cr_actual_repay_full_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_payment_id` (`payment_id`),
    KEY `idx_batch_id` (`batch_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-实际还款表（全量快照）';

CREATE TABLE `cr_client_full_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_business_key` (`business_key`),
    KEY `idx_batch_id` (`batch_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-客户表（全量快照）';

CREATE TABLE `cr_five_class_full_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    ...
    KEY `idx_payment_id` (`payment_id`),
    KEY `idx_batch_id` (`batch_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-五级分类表（全量快照）';

CREATE TABLE `cr_guarantor_full_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_payment_id` (`payment_id`),
    KEY `idx_batch_id` (`batch_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-保证表（全量快照）';

CREATE TABLE `cr_mortgage_full_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_payment_id` (`payment_id`),
    KEY `idx_batch_id` (`batch_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-抵押表（全量快照）';

CREATE TABLE `cr_overdue_record_full_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_payment_id` (`payment_id`),
    KEY `idx_batch_id` (`batch_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-逾期信息表（全量快照）';

CREATE TABLE `cr_pledge_full_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_payment_id` (`payment_id`),
    KEY `idx_batch_id` (`batch_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-质押表（全量快照）';

CREATE TABLE `cr_repay_plan_full_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_payment_id` (`payment_id`),
    KEY `idx_batch_id` (`batch_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-还款计划表（全量快照）';

CREATE TABLE `cr_special_trade_full_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_payment_id` (`payment_id`),
    KEY `idx_batch_id` (`batch_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-特定交易表（全量快照）';
