# 流程快照表
CREATE TABLE `cr_account_proc_snap` (
    ...
    KEY `idx_proc_business_key` (`proc_business_key`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-账户表（流程快照）';

CREATE TABLE `cr_actual_repay_proc_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_batch_id` (`batch_id`),
    KEY `idx_proc_business_key` (`proc_business_key`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-实际还款表（流程快照）';

CREATE TABLE `cr_client_proc_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_batch_id` (`batch_id`),
    KEY `idx_proc_business_key` (`proc_business_key`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-客户表（流程快照）';

CREATE TABLE `cr_five_class_proc_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    ...
    KEY `idx_batch_id` (`batch_id`),
    KEY `idx_proc_business_key` (`proc_business_key`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-五级分类表（流程快照）';

CREATE TABLE `cr_guarantor_proc_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_batch_id` (`batch_id`),
    KEY `idx_proc_business_key` (`proc_business_key`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-保证表（流程快照）';

CREATE TABLE `cr_mortgage_proc_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_batch_id` (`batch_id`),
    KEY `idx_proc_business_key` (`proc_business_key`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-抵押表（流程快照）';

CREATE TABLE `cr_overdue_record_proc_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_batch_id` (`batch_id`),
    KEY `idx_proc_business_key` (`proc_business_key`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-逾期信息表（流程快照）';

CREATE TABLE `cr_pledge_proc_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_batch_id` (`batch_id`),
    KEY `idx_proc_business_key` (`proc_business_key`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-质押表（流程快照）';

CREATE TABLE `cr_repay_plan_proc_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_batch_id` (`batch_id`),
    KEY `idx_proc_business_key` (`proc_business_key`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-还款计划表（流程快照）';

CREATE TABLE `cr_special_trade_proc_snap` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `business_key` varchar(64) NOT NULL COMMENT '业务主键',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY `idx_batch_id` (`batch_id`),
    KEY `idx_proc_business_key` (`proc_business_key`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='征信报送-特定交易表（流程快照）';
