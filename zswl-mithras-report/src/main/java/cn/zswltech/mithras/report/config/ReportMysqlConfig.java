...
@Configuration
@Slf4j
@MapperScan(value = "cn.zswltech.mithras.report.mapper", sqlSessionFactoryRef = "reportSqlSessionFactory")
public class ReportMysqlConfig {
    ...
    @Bean("reportGlobalConfiguration")
    public GlobalConfig reportGlobalConfiguration() {
    ...
    public SqlSessionFactory reportSqlSessionFactory(ObjectProvider<Interceptor[]> interceptorsProvider) throws Exception {
        ...
        sqlSessionFactory.setDataSource(reportDataSource());
...
//        });
        ...
        sqlSessionFactory.setGlobalConfig(reportGlobalConfiguration());
    ...
    public Resource[] resolveMapperLocations() {
        ...
        mapperLocations.add("classpath*:report/mapper/*.xml");
