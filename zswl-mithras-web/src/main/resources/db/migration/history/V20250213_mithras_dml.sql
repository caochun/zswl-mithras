...
VALUES
    ('paymentReviewInAdvanceFileBatchRemove', '付款核销提前审核-文件删除', 0, 16, NULL, NULL, NULL, 'POST', '/file/batch/remove', 1, NULL),
    ('paymentReviewInAdvanceFileListGroup', '付款核销提前审核-文件列表', 0, 16, NULL, NULL, NULL, 'POST', '/file/list/group', 1, NULL),
    ('paymentReviewInAdvanceFileUpload', '付款核销提前审核-文件上传', 0, 16, NULL, NULL, NULL, 'POST', '/file/upload', 2, NULL),
    ('paymentreviewinadvancedsubmit', '付款核销运营提前审核提交审批', 0, 16, NULL, NULL, NULL, 'POST', '/payment/reviewinadvanced/submit', 2, NULL);
-- 付款核销运营提前审核 <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
-- 流动性管理优化 start -------------
UPDATE `fund_parameter_config` set `config_value`='36' WHERE `config_code`= 'accountBalanceCalculateTime';
-- 流动性管理优化 end -------------


-- 黑灰名单sql ----

INSERT INTO bifrost_custom_tree (code, name, flag, sort_no, parent_id, create_by, update_by, en_name, icon, path, lang_env) VALUES ('warehouse', '入库管理', 1, null, 214, null, null, null, null, null, null);
INSERT INTO bifrost_custom_tree (code, name, flag, sort_no, parent_id, create_by, update_by, en_name, icon, path, lang_env) VALUES ('outbound', '出库管理', 1, null, 214, null, null, null, null, null, null);
INSERT INTO bifrost_custom_tree (code, name, flag, sort_no, parent_id, create_by, update_by, en_name, icon, path, lang_env) VALUES ('zhquery', '综合查询', 1, null, 214, null, null, null, null, null, null);
INSERT INTO bifrost_custom_tree (code, name, flag, sort_no, parent_id, create_by, update_by, en_name, icon, path, lang_env) VALUES ('bizParam', '业务参数', 1, null, 214, null, null, null, null, null, null);
...
INSERT INTO bifrost_custom_tree_menu_ref (custom_tree_id, menu_id, sort_no) VALUES ((select id from bifrost_custom_tree where code = 'bizParam'), (select id from bifrost_menu where code = 'blackListManageparameterswarehouse'), 1);
INSERT INTO bifrost_custom_tree_menu_ref (custom_tree_id, menu_id, sort_no) VALUES ((select id from bifrost_custom_tree where code = 'zhquery'), (select id from bifrost_menu where code = 'blackListManagequeryallQuery'), 1);
INSERT INTO bifrost_custom_tree_menu_ref (custom_tree_id, menu_id, sort_no) VALUES ((select id from bifrost_custom_tree where code = 'zhquery'), (select id from bifrost_menu where code = 'blackListManagequeryrecognize'), 1);
INSERT INTO bifrost_custom_tree_menu_ref (custom_tree_id, menu_id, sort_no) VALUES ((select id from bifrost_custom_tree where code = 'outbound'), (select id from bifrost_menu where code = 'blackListManageoutboundapplication'), 1);
INSERT INTO bifrost_custom_tree_menu_ref (custom_tree_id, menu_id, sort_no) VALUES ((select id from bifrost_custom_tree where code = 'outbound'), (select id from bifrost_menu where code = 'blackListManageoutboundsearch'), 1);
INSERT INTO bifrost_custom_tree_menu_ref (custom_tree_id, menu_id, sort_no) VALUES ((select id from bifrost_custom_tree where code = 'warehouse'), (select id from bifrost_menu where code = 'blackListManagewarehousemainTask'), 1);
INSERT INTO bifrost_custom_tree_menu_ref (custom_tree_id, menu_id, sort_no) VALUES ((select id from bifrost_custom_tree where code = 'warehouse'), (select id from bifrost_menu where code = 'blackListManagewarehousesearch'), 1);
delete from bifrost_custom_tree_menu_ref where id in (761, 762);
