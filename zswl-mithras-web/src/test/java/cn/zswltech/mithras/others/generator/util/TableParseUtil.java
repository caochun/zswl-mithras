...
import cn.zswltech.mithras.others.generator.model.FieldInfo;
...
public class TableParseUtil {
     ...
     * @return
     */
    public static ClassInfo processTableIntoClassInfo(String tableSql, Map<String, Object> options) {
        //process the param
        String nameCaseType = MapUtil.getString(options,"nameCaseType");
        Boolean isPackageType = MapUtil.getBoolean(options,"isPackageType");
            ...
            for (String columnLine : fieldLineList) {
                ...
                if (specialFlag) {
                    ...
                    if (columnLine.contains(" tinyint")) {
                        ...
                        fieldClass = MapUtil.getString(options,"tinyintTransType");;
                        jdbcType = "TINYINT";
                    } else if (columnLine.contains(" int") || columnLine.contains(" smallint")) {
                        ...
                        fieldClass =  MapUtil.getString(options,"timeTransType");
                        jdbcType = "TIMESTAMP";
        ...
        codeJavaInfo.setUrlPrefix("/" + tableName.replaceAll("_", "\\/"));
