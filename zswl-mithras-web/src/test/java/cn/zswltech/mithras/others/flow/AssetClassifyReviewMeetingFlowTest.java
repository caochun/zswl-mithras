 ...
 * @description
 */
public class AssetClassifyReviewMeetingFlowTest extends FlowTest {
    @Test
    public void assetClassifyReviewMeetingFlow() throws Exception {
        String fileName = "/bpmn/资产五级分类评审会审批流程.bpmn20.xml";
        ...
        UserTaskExt userTaskReviewMeeting = UserTaskExt.builder()
                .activityId("userTask_reviewMeeting")
                .approvalMethod(ApprovalMethodEnum.PARALLEL.getType())
                .approverType(UserDefineTypeEnum.PROCESS_START_JOB.getType())
                .jobCode(JobEnum.Jury.name())
