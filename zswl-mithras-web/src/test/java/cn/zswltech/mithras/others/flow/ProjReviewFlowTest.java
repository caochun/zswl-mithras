 ...
 */
public class ProjReviewFlowTest extends FlowTest {

    @Test
    public void projReviewFlow() throws Exception {
        List<String> fileNameList = Arrays.asList("bpmn/项目评审创建流程.bpmn20.xml", "bpmn/项目评审修改流程.bpmn20.xml");
        for (String fileName : fileNameList) {
            ...
            UserTaskExt userTaskExtJurySecretary = UserTaskExt.builder()
                    ...
                    .dynamicFormList(Arrays.asList(FlowDynamicFormEnum.projReview_chooseJudges.name(), FlowDynamicFormEnum.projReview_setReviewMeetingPlanDate.name()))
                    .build();
            ...
            UserTaskExt userTaskExtJurySecretaryCollect = UserTaskExt.builder()
                    ...
                    // 显示投票结果 上传会议纪要
                    .dynamicFormList(Arrays.asList(FlowDynamicFormEnum.projReview_showJudgesVotingResults.name(), FlowDynamicFormEnum.projReview_setProjectClassify.name(), FlowDynamicFormEnum.projReview_setMeetingFile.name(), FlowDynamicFormEnum.projReview_setMeetingRecord.name()))
                    .build();
            ...
            UserTaskExt userTaskExtJuryMeetingCollect = UserTaskExt.builder()
                    ...
                    // 显示投票结果 上传会议纪要
                    .dynamicFormList(Arrays.asList(FlowDynamicFormEnum.projReview_showMeetingVotingResults.name(), FlowDynamicFormEnum.projReview_setMeetingFile.name(), FlowDynamicFormEnum.projReview_setMeetingRecord.name()))
                    .build();
            ...
            UserTaskExt userTaskExtDirectorSecretary = UserTaskExt.builder()
                    ...
                    .parallelApprovalMethed(ParallelApprovalMethedEnum.ONE.getType())
                    .buttonList(Arrays.asList(ApprovalButtonTypeEnum.AGREE.name(), ApprovalButtonTypeEnum.DISAGREE.name()))
                    .dynamicFormList(Arrays.asList(FlowDynamicFormEnum.projReview_showDirectors.name(), FlowDynamicFormEnum.projReview_setDirectorMeetingPlanDate.name()))
                    .build();
            ...
            UserTaskExt userTaskExtDirectorSecretaryCollect = UserTaskExt.builder()
                    ...
                    .buttonList(Arrays.asList(ApprovalButtonTypeEnum.AGREE.name(), ApprovalButtonTypeEnum.DISAGREE.name()))
                    // 显示投票结果
                    .dynamicFormList(Arrays.asList(FlowDynamicFormEnum.projReview_showDirectorsVotingResults.name(), FlowDynamicFormEnum.projReview_setDirectorMeetingFile.name()))
                    .build();
