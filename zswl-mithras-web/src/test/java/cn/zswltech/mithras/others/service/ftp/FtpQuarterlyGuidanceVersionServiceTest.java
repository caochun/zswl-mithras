 ...
 */
public class FtpQuarterlyGuidanceVersionServiceTest extends ApplicationTest {
    ...
    public void testCpmpare(){
        CommonVersionDiffRSP commonVersionDiffRSP = versionService.comparePreVersion(9258L);
        System.out.println();
    }
}
