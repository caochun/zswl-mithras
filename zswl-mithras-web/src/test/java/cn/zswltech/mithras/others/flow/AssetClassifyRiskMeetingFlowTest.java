 ...
 * @description
 */
public class AssetClassifyRiskMeetingFlowTest extends FlowTest {
    @Test
    public void assetClassifyRiskMeetingFlow() throws Exception {
        String fileName = "/bpmn/资产五级分类风委会审批流程.bpmn20.xml";
        ...
        UserTaskExt userTaskReviewMeeting = UserTaskExt.builder()
                .activityId("userTask_riskMeeting")
                .approvalMethod(ApprovalMethodEnum.PARALLEL.getType())
                .approverType(UserDefineTypeEnum.PROCESS_START_JOB.getType())
                .jobCode(JobEnum.riskmember.name())
        ...
        UserTaskExt userTaskSecretary = UserTaskExt.builder()
                ...
                .approvalMethod(ApprovalMethodEnum.PARALLEL.getType())
                .approverType(UserDefineTypeEnum.PROCESS_START_JOB.getType())
                .jobCode(JobEnum.risksecretary.name())
                .parallelApprovalMethed(ParallelApprovalMethedEnum.ONE.getType())
