 ...
 * @date: 2023/6/5 10:48
 */
public class ThisYearLaunchContractInfoExtractTest extends ApplicationTest {
    @Resource
    ...
    public void remainingPrincipalTest() {
        ...
        Set<Long> targetContractIds = paymentActualDetailMapper.selectList(
                        Wrappers.<PaymentActualDetail>lambdaQuery()
                                .eq(PaymentActualDetail::getWriteOffStatus, WriteOffStatus.WRITTEN_OFF.name())
                                .le(PaymentActualDetail::getPaidInDate, endDate)
                                .ge(PaymentActualDetail::getPaidInDate, startDate)).stream()
        ...
        List<ContractBaseInfo> contracts = contractBaseInfoService.list(Wrappers.<ContractBaseInfo>lambdaQuery()
                .in(ContractBaseInfo::getId, targetContractIds));
