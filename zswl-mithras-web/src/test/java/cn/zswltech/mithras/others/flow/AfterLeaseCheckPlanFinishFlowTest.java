 ...
 * @description
 */
public class AfterLeaseCheckPlanFinishFlowTest extends FlowTest {
    @Test
    public void checkPlanFinishTest() throws Exception {
        String fileName = "bpmn/租后检查计划完结审批流程.bpmn20.xml";
