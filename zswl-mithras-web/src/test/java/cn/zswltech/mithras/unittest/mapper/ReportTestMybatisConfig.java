...
@MapperScan(basePackages = "cn.zswltech.mithras.report.mapper")
public class ReportTestMybatisConfig {
    ...
    public SqlSessionFactory dbSqlSessionFactory(@Qualifier("testDataSource") DataSource dataSource,
                                                 @Value("classpath*:report/mapper/*Mapper.xml") Resource[] mapperLocations) throws Exception {
