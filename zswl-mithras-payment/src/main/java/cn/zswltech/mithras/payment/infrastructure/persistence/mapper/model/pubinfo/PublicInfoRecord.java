package cn.zswltech.mithras.payment.infrastructure.persistence.mapper.model.pubinfo;
...
public class PublicInfoRecord extends BaseModelWithLogicDelete implements Serializable {
    ...
    /**
     * 关联配置表的KEY {@link cn.zswltech.mithras.payment.domain.enums.pubinfo.PublicInfoRowKeyEnum}
     */
