...
import cn.zswltech.mithras.third.datashare.persistence.model.DataShareCodeDict;
...
import cn.zswltech.mithras.third.datashare.persistence.model.DataShareOrg;
...
public class DataShareServiceImpl implements DataShareService {
    ...
    @Autowired
    private DataShareClientCodeSyncPort dataShareClientCodeSyncPort;
    ...
    private Integer saveMerchants(Integer num, Integer size, String date, int tryNum) {
        ...
        try {
            ...
            if (!ObjectUtil.isEmpty(jsonObject) && "0000".equals(jsonObject.getString("code"))) {
                ...
                dataShareClientCodeSyncPort.syncClientCodes(codeMap);
