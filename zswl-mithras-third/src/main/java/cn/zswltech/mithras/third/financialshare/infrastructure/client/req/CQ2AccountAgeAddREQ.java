...
@Data
public class CQ2AccountAgeAddREQ extends CQ2CommonReq {
     ...
     * 业务日期  取借据维度的起租日期
     */
    private String acctAgeBegining;
     ...
     * 期初款项原值
     */
    private BigDecimal cico_original_qc;

    /**
     * 本期增加额
     */
    private BigDecimal cico_add;

    /**
     * 本期减少额
     */
    private BigDecimal cico_des;
     ...
     * 该行租金的应收日期
     */
    private String cico_overduedate;
