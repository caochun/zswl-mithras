...
@Data
public class CQ2AccountApplicationVO extends CQ2CommonReq {
    ...
    private String cico_taxcategory;//一般计税:	normal 简易计税:	simple  [现有均为推送 normal]
    private String cico_sourcebillno;//来源系统单据编号
    private String mainbiztype_number;//报账业务类型.编码 -  [现有均为推送 JTZB001]
    private String cico_billtype_number = "ssc_tallyapplybill_BT_zb";//单据类型.编码 填默认。。。必填但我方没有
    private List<CQ2AccountApplicationVOBody> tallyentryentity; // 收款明细 [{}] 下面是明细 Y

    @Data
    public class CQ2AccountApplicationVOBody {
        //报账业务类型.编码
        private String businessdate; // 记账明细.业务日期 系统日 Y 记账月的月底
        ...
        private BigDecimal cico_se; // 记账明细.税额 按字段1 description 的类型区分：1）项目起租：起租流程中的 税额 2）项目变更：3）计提利息收入：【税额】列总和 3）计提融资成本：3）计提拨备：4）计提印花税： Y 待补充计算规则
        ...
        private String tallyexplanation;//备注
        /**
         * "根据记账明细.说明 判断
         *          非计提成本的场景：客商编号
         *          计提成本：
        ...
        private String cico_financialins_number;//记账申请单  金融机构.编码
        private String tallydeptid_number;//部门
        private String customer_number;//客户编码
        //private String cico_project2_number;//合同号
        private String cico_project2_name;//合同号
