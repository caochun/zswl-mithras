 ...
 * @author dingqi
 * @date 2023/6/14
 * @description 绩效考核-项目分配表（新）-基本信息版本表
 */
@EqualsAndHashCode(callSuper = true)
@Data
@TableName("kpi_project_distribution_base_info_lib")
public class KpiProjectDistributionBaseInfoLib extends KpiProjectDistributionBaseInfo implements ILib {
    /**
     * 变更编号
     * 版本号
     */
