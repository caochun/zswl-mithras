...
@Data
public class KpiProjGuessDeptListExcelModel extends ExcelModel {

    @SimpleExcelHeader(headerName = "所属部门", headerOrder = 10)
    ...
    //核算月份
    @SimpleExcelHeader(headerName = "核算月份", headerOrder = 60)
