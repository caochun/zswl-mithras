package cn.zswltech.mithras.factory.config;
...
@Configuration
@Slf4j
@MapperScan(value = "cn.zswltech.mithras.factory.mapper", sqlSessionFactoryRef = "factorySqlSessionFactory")
public class FactoryMysqlConfig {
    ...
    @Bean("factoryTransactionManager")
    public DataSourceTransactionManager factoryTransactionManager() {
        return new DataSourceTransactionManager(factoryDataSource());
    }

    @Bean("factoryGlobalConfiguration")
    public GlobalConfig factoryGlobalConfiguration() {
     ...
     * 设置属性
     */
    @Bean("factorySqlSessionFactory")
    public SqlSessionFactory reportSqlSessionFactory(ObjectProvider<Interceptor[]> interceptorsProvider) throws Exception {
        MybatisSqlSessionFactoryBean sqlSessionFactory = new MybatisSqlSessionFactoryBean();
        sqlSessionFactory.setDataSource(factoryDataSource());
...
//        });
        ...
        sqlSessionFactory.setGlobalConfig(factoryGlobalConfiguration());
    ...
    public Resource[] resolveMapperLocations() {
        ...
        mapperLocations.add("classpath*:factory/mapper/*.xml");
