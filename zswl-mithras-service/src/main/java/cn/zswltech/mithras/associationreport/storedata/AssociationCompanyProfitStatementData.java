...
public class AssociationCompanyProfitStatementData extends AbstractDataStore<AssociationCompanyProfitStatement> {
    ...
    protected List<AssociationCompanyProfitStatement> parseFromSystemData(AssociationReport currentReport) {
        ...
        currentReportValue.setBusiFeeCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("销售费用@上年同期累计数")).orElse(0L)));
        currentReportValue.setBusiFeeTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("销售费用@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setCredDecrLossCply(Util.millimeterLong2YuanBigDecimal(-1 * Optional.ofNullable(profitMap.get("☆信用减值损失（损失以“－”号填列）@上年同期累计数")).orElse(0L)));
        currentReportValue.setCredDecrLossTyag(Util.millimeterLong2YuanBigDecimal(-1 * Optional.ofNullable(profitMap.get("☆信用减值损失（损失以“－”号填列）@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setFinFeeCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("财务费用@上年同期累计数")).orElse(0L)));
        currentReportValue.setFinFeeTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("财务费用@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setInctFeeCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("减：所得税费用@上年同期累计数")).orElse(0L)));
        currentReportValue.setInctFeeTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("减：所得税费用@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setIpoaLossCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("资产减值损失（损失以“－”号填列）@上年同期累计数")).orElse(0L)));
        currentReportValue.setIpoaLossTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("资产减值损失（损失以“－”号填列）@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setIvsmPayfCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("投资收益（损失以“－”号填列）@上年同期累计数")).orElse(0L)));
        currentReportValue.setIvsmPayfTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("投资收益（损失以“－”号填列）@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setMagFeeCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("管理费用@上年同期累计数")).orElse(0L)));
        currentReportValue.setMagFeeTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("管理费用@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setMainBusiIncmCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("其中：主营业务收入@上年同期累计数")).orElse(0L)));
        currentReportValue.setMainBusiIncmTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("其中：主营业务收入@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setMainBusiCostCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("其中：主营业务成本@上年同期累计数")).orElse(0L)));
        currentReportValue.setMainBusiCostTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("其中：主营业务成本@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setMainBusiTaxAddCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("税金及附加@上年同期累计数")).orElse(0L)));
        currentReportValue.setMainBusiTaxAddTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("税金及附加@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setNoprIncmCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("加：营业外收入@上年同期累计数")).orElse(0L)));
        currentReportValue.setNoprIncmTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("加：营业外收入@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setNoprPayCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("减：营业外支出@上年同期累计数")).orElse(0L)));
        currentReportValue.setNoprPayTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("减：营业外支出@本年累计数")).orElse(0L)));
        ...
        currentReportValue.setOthBusiProfCply(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("加：其他收益@上年同期累计数")).orElse(0L) + Optional.ofNullable(profitMap.get("资产处置收益（损失以“－”号填列）@上年同期累计数")).orElse(0L)));
        currentReportValue.setOthBusiProfTyag(Util.millimeterLong2YuanBigDecimal(Optional.ofNullable(profitMap.get("加：其他收益@本年累计数")).orElse(0L) + Optional.ofNullable(profitMap.get("资产处置收益（损失以“－”号填列）@本年累计数")).orElse(0L)));
