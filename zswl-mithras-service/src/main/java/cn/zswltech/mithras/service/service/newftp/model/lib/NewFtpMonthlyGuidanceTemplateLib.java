...
/**
 * ftp报价版本表
 * @TableName new_ftp_monthly_guidance_template_lib
 */
@TableName(value ="new_ftp_monthly_guidance_template_lib")
@Data
public class NewFtpMonthlyGuidanceTemplateLib extends NewFtpMonthlyGuidanceTemplateDraft implements ILib, Serializable {
