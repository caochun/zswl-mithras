...
import cn.zswltech.mithras.dto.dashboard.DashboardClientOverviewAllREQ;
import cn.zswltech.mithras.dto.dashboard.DashboardClientOverviewAllRSP;
...
import cn.zswltech.mithras.service.excel.exporter.dashboard.DashboardClientOverviewAllExcelExporter;
 ...
 **/
@Component
public class DashboardClientOverviewAllExportHandle extends ExportHandle<DashboardClientOverviewAllExcelModel, DashboardClientOverviewAllExcelExporter> {
    ...
    public String getBusinessType() {
        return FileExportEnum.DASHBOARD_CLIENT_OVERVIEW_ALL.name();
    }
    ...
    public List<DashboardClientOverviewAllExcelModel> req2ExportList(FileExportREQ req) {
        DashboardClientOverviewAllREQ dashboardClientOverviewAllREQ = BeanUtil.copyProperties(req.getExt(), DashboardClientOverviewAllREQ.class);
        ...
        R<Map<String, Object>> mapR = dashboardClientOverviewController.allPageList(dashboardClientOverviewAllREQ);
        ...
        List<DashboardClientOverviewAllRSP> dashboardClientOverviewAllRSPS = BeanUtil.copyToList(pageR.getList(), DashboardClientOverviewAllRSP.class);
        if (CollectionUtil.isEmpty(req.getIds())) {
            dashboardClientOverviewAllRSPS.add(BeanUtil.copyProperties(data.get(SUM_DATE), DashboardClientOverviewAllRSP.class));
        }
