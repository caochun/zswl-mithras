...
public class FtpQuarterlyCustomerPrincipalPricingFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        return new DefaultDataCompare<FtpQuarterlyCustomerPrincipalPricing, FtpQuarterlyCustomerPrincipalPricingLib, FtpQuarterlyCustomerPrincipalPricingRsp>(rsps, libMapper, handler, commonVersionMapper,BusinessModuleEnum.FTP_QUARTERLY_GUIDANCE.name(), version);
    }
}