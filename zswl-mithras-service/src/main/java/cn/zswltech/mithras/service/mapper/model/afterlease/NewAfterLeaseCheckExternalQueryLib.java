...
@Data
@TableName("new_after_lease_check_external_query_lib")
public class NewAfterLeaseCheckExternalQueryLib extends NewAfterLeaseCheckExternalQuery implements ILib {
    private static final long serialVersionUID = 184217635488312307L;
