 ...
 */
@Data
public class AssociationShahChangeInfo extends BasicAssociationReport implements Serializable, IEntity {
    ...
    * 变更后股东出资金额(万元)
    */
    @TableField("altr_shah_fndr_amt")
    private BigDecimal altrShahFndrAmt;

    /**
    * 变更后持股比例
    */
    @TableField("altr_hold_rati")
