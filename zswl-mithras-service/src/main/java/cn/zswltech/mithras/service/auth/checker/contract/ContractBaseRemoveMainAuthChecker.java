 ...
 */
@Component
public class ContractBaseRemoveMainAuthChecker implements IDataAuthChecker {
    ...
    public boolean check(BusinessModuleEnum businessModule, Class<? extends BaseMapper> helperMapperClass, Long keyId, Object[] args) {
        ...
        commonRemoveMainAuthCheckerNew.check(businessModule, helperMapperClass, keyId, args);
        return true;
    }
