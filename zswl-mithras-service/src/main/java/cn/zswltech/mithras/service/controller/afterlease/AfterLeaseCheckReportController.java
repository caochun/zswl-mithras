...
import cn.zswltech.mithras.service.auth.checker.afterleasecheck.AfterLeaseCheckReportModifyMainChecker;
...
import cn.zswltech.mithras.service.enums.afterlease.NewAfterLeaseCheckMaterialsEnum;
...
public class AfterLeaseCheckReportController implements AfterLeaseCheckReportApi {
    ...
    @DataAuthCheck(keyFieldName = "checkPlanClientId", checkerClass = AfterLeaseCheckReportModifyMainChecker.class, paramType = DataAuthCheck.ParamType.OBJECT, businessModule = BusinessModuleEnum.NEW_AFTER_LEASE_CHECK_REPORT)
    @Override
    ...
    //
    //@DataAuthCheck(keyFieldName = "id", checkerClass = AfterLeaseCheckReportModifyMainChecker.class, paramType = DataAuthCheck.ParamType.OBJECT, businessModule = BusinessModuleEnum.NEW_AFTER_LEASE_CHECK_REPORT)
    @Override
