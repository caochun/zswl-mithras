...
import cn.zswltech.mithras.service.service.newftp.mapper.draft.NewFtpLprPricingDraftMapper;
...
import cn.zswltech.mithras.service.service.newftp.service.lib.NewFtpLprPricingLibService;
            ...
            switch (ftpFrequency) {
                ...
                case SEASON:
                    list.forEach(day -> {
                        ...
                        body.setLprDate(String.format("%s-Q%s", date.getYear(), DateUtil.ensureQuarter(date.getMonthValue())));
                        body.setOneYear(day.getOneYear());
                        body.setFiveYear(day.getFiveYear());
                        body.setId(day.getId());
                        rsp.add(body);
