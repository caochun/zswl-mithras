 ...
 * 风险策略调整，修改后的逻辑：
 * 风控行业分类不为（公用事业类、民生消费类、集团协同业务），R=满足以上条件的「剩余本金之和」/满足以上条件「客户数量」
 *
...
public class MetricComputer14J10000396_JC47548 extends AbstractMetricComputer implements SubscribeSupporter<MetricComputeEvent> {
    ...
    public void onSubscribe(MetricComputeEvent metricComputeEvent) {
        log.info("MetricComputeJ10000396_JC47548 onSubscribe");
...
//        // 浙江客户id
//        Set<Long> clientsInZhejiang =
//                clientService.getSpecifyProvinceClientIds(Collections.singletonList("330000"));
...
//        }
    ...
    @Data
    static class MetricCompute_14Context {
