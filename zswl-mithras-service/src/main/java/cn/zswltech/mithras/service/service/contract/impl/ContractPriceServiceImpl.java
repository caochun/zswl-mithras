...
import cn.zswltech.mithras.contract.service.lib.contract.handler.impl.ContractAocPriceLibHandler;
import cn.zswltech.mithras.contract.service.lib.contract.handler.impl.ContractFactoringPriceLibHandler;
import cn.zswltech.mithras.contract.service.lib.contract.handler.impl.ContractLeasePriceLibHandler;
...
public class ContractPriceServiceImpl implements ContractPriceService {
    ...
    @Autowired
    private ContractAocPriceServiceImpl aocPriceService;
    @Autowired
    private ContractFactoringPriceServiceImpl factoringPriceService;
    @Autowired
