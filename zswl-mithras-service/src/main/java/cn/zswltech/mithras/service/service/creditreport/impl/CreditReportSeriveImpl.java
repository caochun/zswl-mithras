...
*/
    ...
    public List<CreditReportSubmitDTO> submit(CreditReportSubmitCmd cmd) {
        ...
        //校验企业资料是否上传
        List<CreditReportSubmitDTO> submitList = checkEnterprise(cmd.getId(), cmd.getClientId(), CreditReportMaterialTypeEnum.ENTERPRISE_CREDIT_REPORT.name(), BusinessModuleEnum.CREDIT_REPORT_SELECT.name());
