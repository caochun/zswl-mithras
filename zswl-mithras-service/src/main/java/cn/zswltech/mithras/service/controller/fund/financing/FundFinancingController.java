...
public class FundFinancingController implements FundFinancingApi {
    ...
    @DataAuthCheck(checkerClass = FundFinancingMainCreateAuthChecker.class, paramType = DataAuthCheck.ParamType.NO, businessModule = BusinessModuleEnum.FUND_FINANCING)
    @Override
    ...
    @DataAuthCheck(keyFieldName = "financingId", checkerClass = FundFinancingDeleteAuthChecker.class, businessModule = BusinessModuleEnum.FUND_FINANCING)
    @Override
