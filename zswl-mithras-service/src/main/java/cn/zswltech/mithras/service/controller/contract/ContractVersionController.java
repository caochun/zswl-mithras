...
import cn.zswltech.mithras.service.auth.checker.contract.ContractBaseAddMainAuthChecker;
...
//        contractBaseInfoService.updateContractProcessStatus(ContractProcessStatusEnum.CHANGE_UNCOMMIT.name(), req.getChangeType(), req.getContractId());
    ...
    @Override
    //@DataAuthCheck(keyFieldName = "contractId", checkerClass = ContractBaseOperationAuthChecker.class, businessModule = BusinessModuleEnum.CONTRACT)
