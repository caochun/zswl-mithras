...
import cn.zswltech.mithras.service.application.payment.checker.PaymentSubModifyChecker;
...
public class PaymentQuestionnaireAnswerService
    ...
    @DataAuthCheck(
            ...
            checkerClass = PaymentSubModifyChecker.class,
            businessModule = BusinessModuleEnum.PAYMENT
    )
