...
import cn.zswltech.mithras.service.convert.contract.ContractDeductRentInfoConverter;
...
//    }
    ...
    @DataAuthCheck(keyFieldName = "id", paramType = DataAuthCheck.ParamType.OBJECT, businessModule = BusinessModuleEnum.CONTARCT_DEPOSIT, checkerClass = ContarctDepositProviderCheck.class)
