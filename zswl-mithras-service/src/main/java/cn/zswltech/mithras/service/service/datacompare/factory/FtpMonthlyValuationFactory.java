...
public class FtpMonthlyValuationFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        return new DefaultDataCompare<FtpMonthlyValuation, FtpMonthlyValuationLib, FtpMonthlyValuationRsp>(rsps, libMapper, handler, commonVersionMapper,BusinessModuleEnum.FTP_MONTHLY_GUIDANCE.name(), version);
    }
}