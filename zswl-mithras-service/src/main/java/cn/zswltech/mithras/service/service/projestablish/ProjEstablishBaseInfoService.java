...
import cn.zswltech.mithras.system.service.ProjCodeStoreService;
        ...
        if (CollectionUtil.isNotEmpty(mList)) {
            ...
            mList.forEach(item -> {
                ...
                if (Objects.equals(item.getMaterialSubType(), CorporationClientMaterialSubTypeEnum.CREDIT_LETTER.name())) {
                    businessModule = BusinessModuleEnum.PROJ_ESTABLISH.name();
                    ...
                    businessModule = BusinessModuleEnum.PROJ_ESTABLISH_CLIENT.name();
