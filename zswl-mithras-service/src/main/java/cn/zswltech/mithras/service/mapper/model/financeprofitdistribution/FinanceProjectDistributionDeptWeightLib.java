package cn.zswltech.mithras.service.mapper.model.financeprofitdistribution;
...
@Data
@TableName("finance_project_distribution_dept_weight_lib")
public class FinanceProjectDistributionDeptWeightLib extends FinanceProjectDistributionDeptWeight implements ILib {
    /**
     * 变更编号
     * 版本号
     */
