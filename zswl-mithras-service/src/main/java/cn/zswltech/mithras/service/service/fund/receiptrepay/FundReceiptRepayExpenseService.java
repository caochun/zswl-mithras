...
public class FundReceiptRepayExpenseService
    ...
    public void doWriteOffStateModify(Long receiptRepayId, String cashFlowCode) {
        ...
        long hasVerifyAmountExpense = SpringContextHolder.getBean(FundReceiptFlowDetailService.class).sum(fundReceiptRepayExpense.getReceiptRepayId(), fundReceiptRepayExpense.getCashFlowCode());
