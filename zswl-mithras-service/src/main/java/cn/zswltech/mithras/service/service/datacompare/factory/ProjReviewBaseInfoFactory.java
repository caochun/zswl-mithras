...
public class ProjReviewBaseInfoFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        ...
        return new DefaultDataCompare<ProjReviewBaseInfo, ProjReviewBaseInfoLib, ProjReviewBaseInfoDetailRSP>(rsps, libMapper, handler, commonVersionMapper,BusinessModuleEnum.PROJ_REVIEW.name(), version);
    }
}
