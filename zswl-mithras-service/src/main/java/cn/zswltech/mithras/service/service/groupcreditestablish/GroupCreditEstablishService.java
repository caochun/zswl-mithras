...
import cn.zswltech.mithras.service.service.lib.groupcreditestablish.service.impl.GroupCreditEstablishVersionServiceImpl;
...
public class GroupCreditEstablishService {
    ...
    public void effectCheck(GroupCreditEstablishBaseInfo baseInfo) {
        ...
        missRequiredParam(isNull(baseInfo.getApplyCreditAmount()), "授信额度");
    }
