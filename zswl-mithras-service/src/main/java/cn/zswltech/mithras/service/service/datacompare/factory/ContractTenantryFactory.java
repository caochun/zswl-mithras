...
import cn.zswltech.mithras.contract.archive.handler.impl.ContractTenantryLibHandler;
...
public class ContractTenantryFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        return new DefaultDataCompare<ContractTenantry, ContractTenantryLib, ContractTenantryListRSP>(rsps, libMapper, handler,commonVersionMapper, BusinessModuleEnum.CONTRACT.name(), version);
    }
}