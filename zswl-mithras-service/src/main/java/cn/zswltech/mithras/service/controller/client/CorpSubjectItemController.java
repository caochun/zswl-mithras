...
public class CorpSubjectItemController implements CorpSubjectItemApi {
    ...
    @Override
    @DataAuthCheck(paramIndex = 1, checkerClass = ClientAddSubAuthCheckerNew.class, paramType = DataAuthCheck.ParamType.DIRECT, businessModule = BusinessModuleEnum.CLIENT)
...
//                return o1.getId().compareTo(o2.getId());
    ...
    @Override
    @DataAuthCheck(keyFieldName = "clientId", checkerClass = ClientAddSubAuthCheckerNew.class, paramType = DataAuthCheck.ParamType.OBJECT, businessModule = BusinessModuleEnum.CLIENT)
