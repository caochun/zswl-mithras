...
/**
 * 十年期国债收益率版本表
 * @TableName new_ftp_treasury_bond_yield_lib
 */
@TableName(value ="new_ftp_treasury_bond_yield_lib")
@Data
public class NewFtpTreasuryBondYieldLib extends NewFtpTreasuryBondYieldDraft implements ILib, Serializable {
    /**
     * 变更编号
     * 版本号
     */
