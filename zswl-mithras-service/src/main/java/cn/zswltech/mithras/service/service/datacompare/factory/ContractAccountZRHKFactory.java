...
import cn.zswltech.mithras.contract.service.lib.contract.handler.impl.ContractAccountZRHKLibHandler;
 ...
 * @description
 */
@Service("contractAccountZRHK")
public class ContractAccountZRHKFactory implements EditdataCompareFactory {
    @Resource
    private ContractAccountLibMapper libMapper;
    @Resource
    private ContractAccountZRHKLibHandler handler;
    @Resource
