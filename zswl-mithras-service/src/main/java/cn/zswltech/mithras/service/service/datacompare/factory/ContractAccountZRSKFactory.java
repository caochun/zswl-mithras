...
import cn.zswltech.mithras.contract.service.lib.contract.handler.impl.ContractAccountZRSKLibHandler;
 ...
 * @description
 */
@Service("contractAccountZRSK")
public class ContractAccountZRSKFactory implements EditdataCompareFactory {
    @Resource
    private ContractAccountLibMapper libMapper;
    @Resource
    private ContractAccountZRSKLibHandler handler;
    @Resource
