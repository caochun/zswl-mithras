...
import cn.zswltech.mithras.service.service.newftp.service.NewFtpVersionService;
import cn.zswltech.mithras.service.service.newftp.service.drift.NewFtpDescriptionTextDraftService;
...
public class NewFtpBaseInfoController implements NewFtpBaseInfoApi {
    ...
    public R<Map<String, DiffValue>> compareMonthly(NewFtpDetailReq req) {
        ...
        CommonVersion oldVersion = commonVersionMapper.selectOne(Wrappers.<CommonVersion>lambdaQuery()
                ...
                .eq(CommonVersion::getModule, BusinessModuleEnum.NEW_FTP_GUIDANCE.name())
