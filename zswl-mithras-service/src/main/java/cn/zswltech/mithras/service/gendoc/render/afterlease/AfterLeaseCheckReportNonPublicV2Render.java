...
@Slf4j
@Component
public class AfterLeaseCheckReportNonPublicV2Render extends AbstractAfterLeaseCheckReportNonPublicRender {
    @Override
    protected AfterLeaseCheckReportTemplateVersionEnum getTemplateVersion() {
        return AfterLeaseCheckReportTemplateVersionEnum.NON_PUBLIC_V2;
    }
