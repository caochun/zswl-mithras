 ...
 */
@Component
public class AfterLeaseCheckReportLowRiskV3Render extends AbstractAfterLeaseCheckReportRender {
    @Resource
    ...
    protected AfterLeaseCheckReportTemplateVersionEnum getTemplateVersion() {
        return AfterLeaseCheckReportTemplateVersionEnum.LOW_RISK_V3;
    }
    ...
    public String render(OutputStream outputStream, NewAfterLeaseCheckPlanClient o) throws Exception {
        ...
        // 报告内容/总结
        Map<String, NewAfterLeaseCheckReportDetail.FieldData> fieldDataMap = reportBO.getFieldDataList().stream().filter(e -> Objects.equals(e.getModuleIndex(), 0)).collect(Collectors.toMap(NewAfterLeaseCheckReportDetail.FieldData::getFieldName, e -> e, (a, b) -> a));
