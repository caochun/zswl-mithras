...
import cn.zswltech.mithras.service.mapper.dashboard.DashboardAdjustPersonInfoMapper;
import cn.zswltech.mithras.service.mapper.dashboard.DashboardOperationPayMapper;
import cn.zswltech.mithras.service.mapper.model.dashboard.DashboardAdjustPersonInfo;
import cn.zswltech.mithras.service.mapper.model.dashboard.DashboardAdjustPersonLatestQuery;
...
@Slf4j
@Service
public class DashboardOperationCapacityService {
        ...
        for (OrgDO orgDO : sysUserService.listBizDeptSort(req.getType())) {
            ...
            if(CollectionUtils.isNotEmpty(currencyList)){
                ...
                if(!Objects.equals(adjustPersonSum, BigDecimal.ZERO)) {
                    ...
                    rsp.setPersonAverageAmountSum(new ValueUnitDTO(Util.toWanYuanWithoutSplit(personAverageAmountSum.longValue()),"万元"));
                }
                if(projSum != 0) {
                    BigDecimal pieceAverageAmountSum = BigDecimal.valueOf(amountSum).divide(new BigDecimal(projSum), 2, RoundingMode.HALF_UP);
                    rsp.setPieceAverageAmountSum(new ValueUnitDTO(Util.toWanYuanWithoutSplit(pieceAverageAmountSum.longValue()),"万元"));
                }
                rsp.setProjSum(new ValueUnitDTO(String.valueOf(projSum),"个"));
                rsp.setAmountSum(new ValueUnitDTO(Util.toWanYuanWithoutSplit(amountSum),"万元"));
            }
        ...
        for (OrgDO orgDO : sysUserService.listBizDeptSort(req.getType())) {
            ...
            if(CollectionUtils.isNotEmpty(resultCurrencyList)){
                ...
                if(!Objects.equals(adjustPersonSum,BigDecimal.ZERO)) {
                    ...
                    rsp.setPersonAverageAmountSum(new ValueUnitDTO(Util.toYiYuanWithoutSplit(personAverageAmountSum.longValue()),"亿元"));
                    rsp.setPersonAverageProjSum(new ValueUnitDTO(personAverageProjSum.toPlainString(),"个"));
                }
                ...
                rsp.setAmountSum(new ValueUnitDTO(Util.toYiYuanWithoutSplit(currencySum),"亿元"));


                rsp.setPieceAverageAmountSum(new ValueUnitDTO(Util.toYiYuanWithoutSplit(pieceAverageAmountSum.longValue()),"亿元"));
            ...
            if(CollectionUtils.isNotEmpty(resultLastList)){
                ...
                if(!Objects.equals(adjustPersonSum,BigDecimal.ZERO)) {
                    ...
                    rsp.setLastPersonAverageAmountSum(new ValueUnitDTO(Util.toYiYuanWithoutSplit(personAverageAmountSum.longValue()),"亿元"));
                ...
                rsp.setLastPieceAverageAmountSum(new ValueUnitDTO(Util.toYiYuanWithoutSplit(pieceAverageAmountSum.longValue()),"亿元"));
                rsp.setLastAmountSum(new ValueUnitDTO(Util.toYiYuanWithoutSplit(lastSum), "亿元"));
