...
import cn.zswltech.mithras.service.service.third.financial.req.CQReceiveREQ;
...
public class ReceiveHandle extends FinancialApiHandler<List<CQReceiveREQ>, FinancialCommonRSP> {
    ...
    public void cqRelatedMithras(FinancialCommonRSP result){
        financialConfigService.cqRelatedMithras(result, RecordSourceEnum.COLLECTION.name());
    }
