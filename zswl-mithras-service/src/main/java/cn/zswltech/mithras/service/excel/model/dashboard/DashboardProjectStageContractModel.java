...
@Data
public class DashboardProjectStageContractModel extends ExcelModel {
    ...
    @SimpleExcelHeader(headerName = "合同金额", headerOrder = 40, columnStyle = ColumnStyleEnum.MONEY)
    private String contractAmount;

    @SimpleExcelHeader(headerName = "签约状态", headerOrder = 50)
    ...
    @SimpleExcelHeader(headerName = "风控行业分类", headerOrder = 70)
    private String riskControlIndustryClassifyDisplay;

    @SimpleExcelHeader(headerName = "租赁期限（月）", headerOrder = 80, columnStyle = ColumnStyleEnum.MONEY)
    private String leaseDuration;

    @SimpleExcelHeader(headerName = "租赁利率", headerOrder = 90, columnStyle = ColumnStyleEnum.MONEY)
    private String interestRate;

    @SimpleExcelHeader(headerName = "当前阶段停留天数（工作日）", headerOrder = 100, columnStyle = ColumnStyleEnum.MONEY)
    ...
    @SimpleExcelHeader(headerName = "申请时间", headerOrder = 180)
