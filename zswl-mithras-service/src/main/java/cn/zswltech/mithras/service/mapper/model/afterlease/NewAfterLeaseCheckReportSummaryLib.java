...
@Data
@TableName("new_after_lease_check_report_summary_lib")
public class NewAfterLeaseCheckReportSummaryLib extends NewAfterLeaseCheckReportSummary implements ILib {
    private static final long serialVersionUID = 4466427631129458155L;
