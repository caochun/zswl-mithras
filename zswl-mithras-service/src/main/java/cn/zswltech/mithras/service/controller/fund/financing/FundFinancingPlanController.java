...
public class FundFinancingPlanController implements FundFinancingPlanApi {
    ...
    @DataAuthCheck(keyFieldName = "id", checkerClass = FundFinancingSubModifyAuthChecker.class, businessModule = BusinessModuleEnum.FUND_FINANCING, mapperClass = FundFinancingPlanMapper.class)
    @Override
