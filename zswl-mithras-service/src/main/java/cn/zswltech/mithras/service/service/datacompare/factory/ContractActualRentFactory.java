...
public class ContractActualRentFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        return new DefaultDataCompare<ContractReceipt, ContractReceiptLib, ContractRentActualListRSP>(rsps, libMapper, handler,commonVersionMapper, BusinessModuleEnum.CONTRACT.name(), version);
    }
    ...
    public static class ContractActualRentChildrenFactory implements EditdataCompareFactory {
        ...
        @Override
        public AbstractDataCompare createCompare(List rsps, String version) {
            return new DefaultDataCompare<ContractRentActual, ContractRentActualLib, ContractRentActualRSP>(rsps, libMapper, handler,commonVersionMapper, BusinessModuleEnum.CONTRACT.name(), version);
        }
    }
}
