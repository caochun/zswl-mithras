...
import cn.zswltech.mithras.service.service.liquidityrisk.CapitalOutflowService;
...
//    @DataAuthCheck(checkerClass = LiquidityRiskViewMainAuthChecker.class, businessModule = BusinessModuleEnum.VIRTUAL_LIQUIDITY_RISK)
    ...
    @Override
    //@DataAuthCheck(checkerClass = LiquidityRiskViewMainAuthChecker.class, businessModule = BusinessModuleEnum.VIRTUAL_LIQUIDITY_RISK)
    public R<List<CashInOutStatRSP>> cashInOutStat(@RequestBody @Valid CashInOutStatREQ req) {
