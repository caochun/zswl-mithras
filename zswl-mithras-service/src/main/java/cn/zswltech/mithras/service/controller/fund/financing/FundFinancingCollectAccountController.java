...
import cn.zswltech.mithras.service.mapper.fund.financing.FundFinancingCollectAccountMapper;
import cn.zswltech.mithras.service.mapper.model.fund.financing.FundFinancingCollectAccount;
import cn.zswltech.mithras.service.service.fund.financing.FundFinancingBaseInfoService;
import cn.zswltech.mithras.service.service.fund.financing.FundFinancingCollectAccountService;
...
public class FundFinancingCollectAccountController implements FundFinancingCollectAccountApi {
    ...
    @DataAuthCheck(keyFieldName = "id", checkerClass = FundFinancingSubModifyAuthChecker.class, businessModule = BusinessModuleEnum.FUND_FINANCING, mapperClass = FundFinancingCollectAccountMapper.class)
    @Override
    @Transactional(rollbackFor = Throwable.class)
