...
//    @DataAuthCheck(keyFieldName = "id", checkerClass = CommonModifyMainAuthCheckerNew.class, paramType = DataAuthCheck.ParamType.OBJECT, businessModule = BusinessModuleEnum.NEW_AFTER_LEASE_CHECK_REPORT)
    @Override
    ...
    @DataAuthCheck(keyFieldName = "id", checkerClass = AfterLeaseCheckPlanModifySubChecker.class, paramType = DataAuthCheck.ParamType.OBJECT, mapperClass = NewAfterLeaseCheckPlanClientMapper.class, businessModule = BusinessModuleEnum.NEW_AFTER_LEASE_CHECK_PLAN)
    @Override
