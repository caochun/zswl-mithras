 ...
 */
@Component
public class ContractEntityItemMortgageExcelImporter extends AbstractSimpleExcelImporter<ContractEntityMortgageItemExcelModel> {
    @Override
    ...
    @Override
    protected Class<ContractEntityMortgageItemExcelModel> modelClz() {
        return ContractEntityMortgageItemExcelModel.class;
    }
