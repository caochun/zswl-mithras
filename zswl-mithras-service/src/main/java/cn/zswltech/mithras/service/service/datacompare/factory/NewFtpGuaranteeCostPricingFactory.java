...
public class NewFtpGuaranteeCostPricingFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        return new DefaultDataCompare<NewFtpGuaranteeCostPricingDraft, NewFtpGuaranteeCostPricingLib, NewFtpGuaranteeCostPricingListRSP>(rsps, libMapper, handler, commonVersionMapper, BusinessModuleEnum.NEW_FTP_GUIDANCE.name(), version);
    }
}