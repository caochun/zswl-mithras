...
@Data
@TableName("new_ftp_quarterly_base_pricing_ext_lib")
public class NewFtpQuarterlyBasePricingExtLib extends NewFtpQuarterlyBasePricingExtDraft implements ILib, Serializable {
    /**
     * 变更编号
     * 版本号
     */
