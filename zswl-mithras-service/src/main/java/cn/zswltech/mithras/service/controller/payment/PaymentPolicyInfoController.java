...
public class PaymentPolicyInfoController implements PaymentPolicyInfoApi {
    ...
    @DataAuthCheck(keyFieldName = "paymentId", paramType = DataAuthCheck.ParamType.DIRECT,
            paramIndex = 1,checkerClass = PaymentModifyAuthChecker.class, businessModule = BusinessModuleEnum.PAYMENT, mapperClass = PaymentPolicyInfoMapper.class)
    ...
    @DataAuthCheck(keyFieldName = "paymentId", paramType = DataAuthCheck.ParamType.OBJECT,
            paramIndex = 2, checkerClass = PaymentModifyAuthChecker.class, businessModule = BusinessModuleEnum.PAYMENT, mapperClass = PaymentPolicyInfoMapper.class)
    ...
    @Override
    @DataAuthCheck(keyFieldName = "id", checkerClass = PaymentModifyAuthChecker.class, businessModule = BusinessModuleEnum.PAYMENT, mapperClass = PaymentPolicyInfoMapper.class)
    ...
    @Override
    @DataAuthCheck(keyFieldName = "paymentId", checkerClass = PaymentModifyAuthChecker.class, businessModule = BusinessModuleEnum.PAYMENT, mapperClass = PaymentPolicyInfoMapper.class)
    ...
    @Override
    @DataAuthCheck(keyFieldName = "paymentId", checkerClass = PaymentModifyAuthChecker.class, businessModule = BusinessModuleEnum.PAYMENT)
