...
import static cn.zswltech.mithras.customer.domain.enums.client.ClientProcessStatus.UNDER_APPROVAL;
...
import static cn.zswltech.mithras.customer.domain.enums.client.ClientType.CORPORATION;
import static cn.zswltech.mithras.customer.domain.enums.client.ClientType.NORMAL;
...
import static cn.zswltech.mithras.service.enums.projreview.ReviewRelationDataType.PROJ_ESTABLISH;
...
import static cn.zswltech.mithras.service.service.projfms.ProjProcessState.CHANGING_UNDER_APPROVAL;
import static cn.zswltech.mithras.service.service.projfms.ProjProcessState.NEW_UNDER_APPROVAL;
...
//    }
    ...
    @DataAuthCheck(checkerClass = CommonAddMainAuthCheckerNew.class, paramType = DataAuthCheck.ParamType.NO, businessModule = BusinessModuleEnum.CLIENT)
...
//            throw new MithrasException("该客户已存在");
        ...
        corpAddressInfoService.addByCommerceInfo(client.getId(), baseInfo);
    ...
    @Override
    @DataAuthCheck(keyFieldName = "id", checkerClass = ClientRemoveMainAuthCheckerNew.class, businessModule = BusinessModuleEnum.CLIENT)
    ...
    @Override
    @DataAuthCheck(keyFieldName = "id", checkerClass = ClientModifyMainAuthCheckerNew.class, businessModule = BusinessModuleEnum.CLIENT)
