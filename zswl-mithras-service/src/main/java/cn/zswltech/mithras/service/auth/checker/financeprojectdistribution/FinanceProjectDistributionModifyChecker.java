package cn.zswltech.mithras.service.auth.checker.financeprojectdistribution;
...
public class FinanceProjectDistributionModifyChecker implements IDataAuthChecker {
    ...
    public boolean check(BusinessModuleEnum businessModule, Class<? extends BaseMapper> helperMapperClass, Long keyId, Object[] args) {
        ...
        ProcessResp processResp = processService.findRelatedProcess(String.valueOf(financeProjectDistribution.getId()), BusinessModuleEnum.FINANCE_PROJECT_DISTRIBUTION.getModelKeyList());
