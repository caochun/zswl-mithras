 ...
 * 合同租赁物评估机构关联草稿表
 * @author bigbear
 * @TableName contract_evaluation_agency_draft
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
...
@TableName(value ="contract_evaluation_agency_draft")
public class ContractEvaluationAgencyDraft extends BaseModelWithLogicDelete {
    /**
     * 主键id
     */
