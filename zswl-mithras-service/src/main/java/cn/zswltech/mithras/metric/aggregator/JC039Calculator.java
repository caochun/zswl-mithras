...
import static cn.zswltech.mithras.metric.aggregator.AggConst.CHEMICAL_INDUSTRY_CODE;
 ...
 */
@Component
public class JC039Calculator implements MetricCalculator {
    ...
    public Map<String, Long> varMap(LocalDate date) {
        ...
        RiskMetricDict dict = metricDictService.getOne(Wrappers.<RiskMetricDict>lambdaQuery()
                ...
                .eq(RiskMetricDict::getDictKey, "CHEMICAL")
        );
        ...
        wrapper.eq("industry_type", CHEMICAL_INDUSTRY_CODE);
