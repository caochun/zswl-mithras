 ...
 */
@Component
public class JC037Calculator implements MetricCalculator {
    ...
    public Map<String, Long> varMap(LocalDate date) {
        ...
        RiskMetricDict dict = metricDictService.getOne(Wrappers.<RiskMetricDict>lambdaQuery()
                ...
                .eq(RiskMetricDict::getDictKey, "ENGINEERING_MACHINE")
        );
        ...
        wrapper.eq("industry_type", ENGINEERING_MACHINE_INDUSTRY_CODE);
