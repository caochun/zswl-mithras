...
import static cn.zswltech.mithras.metric.aggregator.AggConst.PAPER_MAKING_INDUSTRY_CODE;
 ...
 */
@Component
public class JC038Calculator implements MetricCalculator {
    ...
    public Map<String, Long> varMap(LocalDate date) {
        ...
        RiskMetricDict dict = metricDictService.getOne(Wrappers.<RiskMetricDict>lambdaQuery()
                ...
                .eq(RiskMetricDict::getDictKey, "PAPER_MAKING")
        );
        ...
        wrapper.eq("industry_type", PAPER_MAKING_INDUSTRY_CODE);
