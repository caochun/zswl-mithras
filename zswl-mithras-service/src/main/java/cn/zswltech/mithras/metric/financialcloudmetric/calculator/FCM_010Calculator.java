 ...
 */
@Component
public class FCM_010Calculator extends AverageFinancingCostCalculator {
    ...
    protected List<FundFinancingBaseInfo> getFinancings(LocalDate dateTime) {
        List<FundFinancingBaseInfo> fundFinancingBaseInfos = financingBaseInfoService.list(Wrappers.<FundFinancingBaseInfo>lambdaQuery()
                ...
                .eq(FundFinancingBaseInfo::getBusinessType, FundFinancingBizTypeEnum.BANK_ACCEPTANCE.name()));
