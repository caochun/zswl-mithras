...
import cn.zswltech.mithras.service.auth.checker.kpi.KpiParameterConfigModifyChecker;
...
import cn.zswltech.mithras.service.service.finance.ContractAssessDeptDetailService;
...
public class KpiParameterConfigController implements KpiParameterConfigApi {
    ...
    @DataAuthCheck(paramType = DataAuthCheck.ParamType.NO, checkerClass = KpiParameterConfigModifyChecker.class, businessModule = BusinessModuleEnum.KPI_PARAMETER_CONFIG)
    @Override
