...
public abstract class AbstractMetricComputer {
    ...
    @Resource
    private RiskControlMetricStrategyService riskControlMetricStrategyService;
    @Resource
    ...
    public void compute(MetricComputeEvent metricComputeEvent) {
        ...
        RiskControlStrategy theOne = riskControlMetricStrategyService.getOne(Wrappers.<RiskControlStrategy>lambdaQuery()
        ...
        try {
            ...
            if (!LocalDate.now().equals(metricComputeEvent.getSnapshotDate())) {
                ...
                riskControlMetricStrategyService.updateById(theOne);
            }
        } catch (Throwable t) {
