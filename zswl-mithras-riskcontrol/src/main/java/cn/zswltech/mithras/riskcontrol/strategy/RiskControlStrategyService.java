...
import cn.zswltech.mithras.riskcontrol.metric.subscriber.MetricComputer29J10000396_FJC47608;
...
//                        && declaredAmount > strategy_16.getLimitValueOne() * 100000000L) {
//                    // 预警值可以为空 为空时不做拦截
...
//        }
        ...
        if (!Objects.equals(classify, RiskControlIndustryClassify.INNOVATION_BUSINESS.name())) {
            ...
            if (ObjectUtil.isNotEmpty(strategy)) {
                if (!strategy.industryClassifyCanPass(declaredAmount)) {
