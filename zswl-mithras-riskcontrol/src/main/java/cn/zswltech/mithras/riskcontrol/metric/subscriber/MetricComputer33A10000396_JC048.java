...
@Component
@Slf4j
public class MetricComputer33A10000396_JC048 extends RegionalRiskQuotaComputer
    ...
    public void onSubscribe(MetricComputeEvent metricComputeEvent) {
        log.info("MetricComputeA10000396_JC048 onSubscribe");
    ...
    protected List<RegionalProjectClassify> getRegionalProjectClassify() {
        return Arrays.asList(RegionalProjectClassify.CAUTIOUS_SUPPORT);
    }
}
