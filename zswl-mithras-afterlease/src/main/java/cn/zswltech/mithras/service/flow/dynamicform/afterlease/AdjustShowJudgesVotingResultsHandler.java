 ...
 */
@Component
public class AdjustShowJudgesVotingResultsHandler implements DynamicFormHandler {
    ...
    public void collect(TaskDetailRSP rsp) {
        ...
        List<VoteFormRSP.VoteRSP> voteRSPList = processApiService.queryVoteResult(rsp.getProcessInstanceId(), "userTask_juryVote")
                .stream()
                // 一人一票 去重
    ...
    public FlowDynamicFormEnum getType() {
        return FlowDynamicFormEnum.adjust_showJudgesVotingResults;
    }
