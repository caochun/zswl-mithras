...
public class AfterLeaseCheckReportBaseServiceImpl extends ServiceImpl<NewAfterLeaseCheckReportBaseMapper, NewAfterLeaseCheckReportBase> implements AfterLeaseCheckReportBaseService {
    ...
    @Resource
    private AfterLeaseIndustryPort afterLeaseIndustryPort;
    @Resource
    ...
    public AfterLeaseCheckReportBaseRSP getCheckReportBaseRSP(Long checkPlanClientId, String version) {
        ...
        Map<Long, Long> clientRemainingPrincipalMap = afterLeaseClientPort.getClientRemainingPrincipalMap(Collections.singletonList(checkPlanClient.getClientId()));
        Map<Long, Long> clientStockRiskExposureMap = afterLeaseClientPort.clientStockRiskExposureMap(Collections.singletonList(checkPlanClient.getClientId()));
        ...
        if (ObjectUtil.isEmpty(rsp.getRiskExposure())) {
            rsp.setRiskExposure(afterLeaseContractPort.getStockRiskExposure(checkPlanClient.getClientId()));
        }
