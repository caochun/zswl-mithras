...
@Data
@TableName("new_after_lease_check_report_content_lib")
public class NewAfterLeaseCheckReportContentLib extends NewAfterLeaseCheckReportContent implements ILib {
    private static final long serialVersionUID = 5854752411801766752L;
