...
public class AfterLeaseCheckReportDownloadServiceImpl implements AfterLeaseCheckReportDownloadService {
    private static final String BUSINESS_MODULE_NEW_AFTER_LEASE_CHECK_REPORT = "NEW_AFTER_LEASE_CHECK_REPORT";
    ...
    @Resource
    private AfterLeaseCheckReportRenderPort afterLeaseCheckReportRenderPort;
    @Resource
    ...
    private String generatePublicReportFile(NewAfterLeaseCheckReportMeta checkReportMeta, NewAfterLeaseCheckPlanClient checkPlanClient) {
        ...
        try (OutputStream outputStream = FileUtil.getOutputStream(filePath)) {
            afterLeaseCheckReportRenderPort.render(outputStream, checkPlanClient, checkReportMeta.getReportType(), checkReportMeta.getReportTemplateVersion());
        } catch (Exception e) {
