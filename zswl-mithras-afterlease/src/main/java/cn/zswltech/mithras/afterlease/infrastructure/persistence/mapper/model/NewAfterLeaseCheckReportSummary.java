...
@Data
@TableName("new_after_lease_check_report_summary")
public class NewAfterLeaseCheckReportSummary extends BaseModel implements Serializable, IEntity {
    private static final long serialVersionUID = -8166034850080320491L;
