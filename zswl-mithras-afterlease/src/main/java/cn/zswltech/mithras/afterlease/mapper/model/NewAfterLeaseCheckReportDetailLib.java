...
@Data
@TableName("new_after_lease_check_report_detail_lib")
public class NewAfterLeaseCheckReportDetailLib extends NewAfterLeaseCheckReportDetail implements ILib {
    /**
     * 变更编号
     * 版本号
     */
