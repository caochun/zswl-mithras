...
@Data
@TableName("new_after_lease_check_external_query_client_info_lib")
public class NewAfterLeaseCheckExternalQueryClientInfoLib extends NewAfterLeaseCheckExternalQueryClientInfo implements ILib {
    private static final long serialVersionUID = -4942384753337236289L;
