...
@Data
@TableName("new_after_lease_check_report_base_lib")
public class NewAfterLeaseCheckReportBaseLib extends NewAfterLeaseCheckReportBase implements ILib {
    private static final long serialVersionUID = 6058878500121387939L;
