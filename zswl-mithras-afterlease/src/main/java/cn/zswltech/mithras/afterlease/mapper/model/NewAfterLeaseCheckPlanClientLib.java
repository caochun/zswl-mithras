...
@Data
@TableName("new_after_lease_check_plan_client_lib")
public class NewAfterLeaseCheckPlanClientLib extends NewAfterLeaseCheckPlanClient implements ILib {
    private static final long serialVersionUID = -5052279555686178673L;
