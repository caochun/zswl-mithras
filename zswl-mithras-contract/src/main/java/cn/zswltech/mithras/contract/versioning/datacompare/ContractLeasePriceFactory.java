...
public class ContractLeasePriceFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        return new DefaultDataCompare<ContractLeasePrice, ContractLeasePriceLib, ContractLeasePriceDetailRSP>(rsps, libMapper, handler, commonVersionMapper,"CONTRACT", version);
    }
}