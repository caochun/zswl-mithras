...
import cn.zswltech.mithras.contract.application.ContractPrepaymentApplicationService;
...
//    @DataAuthCheck(keyFieldName = "id", checkerClass = ContractBaseModifySubAuthChecker.class, businessModule = "CONTRACT", mapperClass = ContractPrepaymentMapper.class)
