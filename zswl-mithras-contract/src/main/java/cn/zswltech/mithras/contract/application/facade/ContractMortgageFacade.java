...
import cn.zswltech.mithras.contract.application.ContractMortgageApplicationService;
...
@Service
@Slf4j
public class ContractMortgageFacade implements ContractMortgageApplicationService {
    ...
    @Override
    @ContractChangeOther
    @DataAuthCheck(keyFieldName = "contractId", checkerClass = ContractBaseModifyMainAuthChecker.class, businessModule = "CONTRACT", mapperClass = ContractMortgageMapper.class)
    ...
    @Override
    @ContractChangeOther
    @DataAuthCheck(keyFieldName = "id", checkerClass = ContractBaseModifySubAuthChecker.class, businessModule = "CONTRACT", mapperClass = ContractMortgageMapper.class)
    ...
    @Override
    @ContractChangeOther
    @DataAuthCheck(keyFieldName = "id", checkerClass = ContractBaseRemoveSubAuthChecker.class, businessModule = "CONTRACT", mapperClass = ContractMortgageMapper.class)
