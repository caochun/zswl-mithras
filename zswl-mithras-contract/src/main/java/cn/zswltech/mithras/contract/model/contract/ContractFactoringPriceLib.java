...
@Data
@TableName("contract_factoring_price_lib")
public class ContractFactoringPriceLib extends ContractFactoringPrice implements ILib {
    private static final long serialVersionUID = 9040493858442887236L;
