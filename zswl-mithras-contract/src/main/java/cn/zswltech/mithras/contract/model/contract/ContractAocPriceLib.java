...
@Data
@TableName("contract_aoc_price_lib")
public class ContractAocPriceLib extends ContractAocPrice implements ILib {
    private static final long serialVersionUID = 2720294870666041121L;
