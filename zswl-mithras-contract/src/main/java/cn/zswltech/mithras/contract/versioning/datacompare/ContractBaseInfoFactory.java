...
public class ContractBaseInfoFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        return new DefaultDataCompare<ContractBaseInfo, ContractBaseInfoLib, ContractBaseInfoDetailRSP>(rsps, libMapper, handler,commonVersionMapper, "CONTRACT", version);
    }
}