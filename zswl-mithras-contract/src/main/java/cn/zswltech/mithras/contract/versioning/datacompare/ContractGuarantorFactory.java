...
public class ContractGuarantorFactory implements EditdataCompareFactory {
    ...
    public AbstractDataCompare createCompare(List rsps, String version) {
        return new DefaultDataCompare<ContractGuarantor, ContractGuarantorLib, ContractGuarantorListRSP>(rsps, libMapper, handler,commonVersionMapper, "CONTRACT", version);
    }
}