 ...
 */
@Service
public class ContractAccountBLSKLibHandler extends AbstractContractAccountLibHandler {


    @Override
    public ContractLibModelEnum getSubModule() {
        return ContractLibModelEnum.BANK_ACCOUNT_BLSK;
    }
    ...
    public ContractAccountUseEnum getAccountUseEnum() {
        return ContractAccountUseEnum.BLSK;
    }
}
