...
@Data
@TableName("contract_settle_plan_lib")
public class ContractSettlePlanLib extends ContractSettlePlan implements ILib {
    private static final long serialVersionUID = 3786457162034463938L;
