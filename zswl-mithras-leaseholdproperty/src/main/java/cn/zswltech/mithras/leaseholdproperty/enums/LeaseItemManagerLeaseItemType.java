...
public enum LeaseItemManagerLeaseItemType implements PullDown {
    ...
    NO_PRODUCTION_LINE_EQUIPMENT("非生产线设备", Arrays.asList("生产线名称", "设备名称*", "规格型号", "数量", "单位", "供应商/销货方", "入账/购置日期", "账面原值（元）", "账面净值（元）", "评估原值（元）", "评估净值（元）", "发票号", "存放地点*", "其他")),
    PRODUCTION_EQUIPMENT("生产设备", Arrays.asList("生产线名称", "设备名称*", "规格型号", "数量", "单位", "供应商/销货方", "入账/购置日期", "账面原值（元）", "账面净值（元）", "评估原值（元）", "评估净值（元）", "发票号", "存放地点*", "其他")),
    PRODUCTION_LINE("生产线", Arrays.asList("生产线名称", "设备名称*", "规格型号", "数量", "单位", "供应商/销货方", "入账/购置日期", "账面原值（元）", "账面净值（元）", "评估原值（元）", "评估净值（元）", "发票号", "存放地点*", "其他")),
