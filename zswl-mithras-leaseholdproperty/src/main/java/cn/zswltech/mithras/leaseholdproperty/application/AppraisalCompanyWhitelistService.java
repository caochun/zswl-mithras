...
public class AppraisalCompanyWhitelistService extends ServiceImpl<AppraisalCompanyWhitelistMapper, AppraisalCompanyWhitelist> {
    ...
    @Resource
    private AppraisalCompanyWhitelistMaterialPort appraisalCompanyWhitelistMaterialPort;
    ...
    public String submit(SinglePkREQ req) {
        ...
        // 校验资料
        int count = appraisalCompanyWhitelistMaterialPort.countMaterials(BUSINESS_TYPE, id);
        if (count == 0) {
