...
import cn.zswltech.mithras.ftp.newftp.convert.NewFtpCommonConvert;
...
public class NewFtpMonthlyGuidanceDraftService
    ...
    public Map<String, String> getRowKeysMap(Long ftpId) {
        ...
        // 前十一行一致，统一处理
        rowKeysMap.put("row1", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.INDUSTRY, AssetIndustryClassify.ENCOURAGE_INTERVENTION, RegionalClassify.ZHEJIANG));
        rowKeysMap.put("row2", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.INDUSTRY, AssetIndustryClassify.ENCOURAGE_INTERVENTION, RegionalClassify.ENCOURAGE));
        rowKeysMap.put("row3", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.INDUSTRY, AssetIndustryClassify.ENCOURAGE_INTERVENTION, RegionalClassify.OTHER));
        rowKeysMap.put("row4", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.INDUSTRY, AssetIndustryClassify.MODERATE_SUPPORT, RegionalClassify.ZHEJIANG));
        rowKeysMap.put("row5", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.INDUSTRY, AssetIndustryClassify.MODERATE_SUPPORT, RegionalClassify.ENCOURAGE));
        rowKeysMap.put("row6", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.INDUSTRY, AssetIndustryClassify.MODERATE_SUPPORT, RegionalClassify.OTHER));
        rowKeysMap.put("row7", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.INDUSTRY, AssetIndustryClassify.CAUTIOUS_SUPPORT, RegionalClassify.ZHEJIANG));
        rowKeysMap.put("row8", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.INDUSTRY, AssetIndustryClassify.CAUTIOUS_SUPPORT, RegionalClassify.ENCOURAGE));
        rowKeysMap.put("row9", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.INDUSTRY, AssetIndustryClassify.CAUTIOUS_SUPPORT, RegionalClassify.OTHER));
        switch (ftpBusinessVersion) {
            case V2: {
                rowKeysMap.put("row10", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.PUBLIC_UTILITY, null, RegionalClassify.ZHEJIANG));
                rowKeysMap.put("row11", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.PUBLIC_UTILITY, null, RegionalClassify.ENCOURAGE));
                rowKeysMap.put("row12", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.PUBLIC_UTILITY, null, RegionalClassify.OTHER));
                // 重要！！！第十三行（工程机械类（厂商担保模式））拿掉了
                rowKeysMap.put("row14", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.COLLABORATIVE_LEASING_BUSINESS, null, null));
                rowKeysMap.put("row15", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.COLLABORATIVE_FACTORING_BUSINESS, null, null));
                return rowKeysMap;
            }
            case V3: {
                // 重要！！！第十行（工程机械类（厂商担保模式））拿掉了
                rowKeysMap.put("row11", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.COLLABORATIVE_LEASING_BUSINESS, null, null));
                rowKeysMap.put("row12", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.COLLABORATIVE_FACTORING_BUSINESS, null, null));
                rowKeysMap.put("row13", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.PUBLIC_UTILITY, null, RegionalClassify.ZHEJIANG));
                rowKeysMap.put("row14", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.PUBLIC_UTILITY, null, RegionalClassify.ENCOURAGE));
                rowKeysMap.put("row15", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.PUBLIC_UTILITY, null, RegionalClassify.OTHER));
                rowKeysMap.put("row16", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.CIVIL_CONSUMPTION, null, RegionalClassify.ZHEJIANG));
                rowKeysMap.put("row17", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.CIVIL_CONSUMPTION, null, RegionalClassify.ENCOURAGE));
                rowKeysMap.put("row18", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.CIVIL_CONSUMPTION, null, RegionalClassify.OTHER));
                rowKeysMap.put("row19", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.STATE_OWNED_INDUSTRY, null, RegionalClassify.ZHEJIANG));
                rowKeysMap.put("row20", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.STATE_OWNED_INDUSTRY, null, RegionalClassify.ENCOURAGE));
                rowKeysMap.put("row21", NewFtpCommonConvert.appendFtpGuidanceKey(RiskIndustryClassify.STATE_OWNED_INDUSTRY, null, RegionalClassify.OTHER));
                return rowKeysMap;
            }
            default: {
