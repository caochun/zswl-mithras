...
/**
 * ftp报价编辑区表
 * @TableName new_ftp_monthly_guidance_lib
 */
@TableName(value ="new_ftp_monthly_guidance_lib")
@Data
public class NewFtpMonthlyGuidanceLib extends NewFtpMonthlyGuidanceDraft implements ILib, Serializable {
