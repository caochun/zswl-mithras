...
/**
 * lpr配置版本表
 * @TableName new_ftp_lpr_pricing_lib
 */
@TableName(value ="new_ftp_lpr_pricing_lib")
@Data
public class NewFtpLprPricingLib extends NewFtpLprPricingDraft implements ILib, Serializable {
