 ...
 */
public enum FtpProcessStatus implements PullDown, ProcessStatus {
    /**
     * 初始状态
     */
    ...
    FtpProcessStatus(String display, boolean finalState) {
    ...
    public static FtpProcessStatus of(String code) {
        for (FtpProcessStatus value : FtpProcessStatus.values()) {
