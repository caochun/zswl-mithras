...
/**
 * 十年国债收益波动情况版本表
 * @TableName new_ftp_treasury_bond_yield_pricing_lib
 */
@TableName(value ="new_ftp_treasury_bond_yield_pricing_lib")
@Data
public class NewFtpTreasuryBondYieldPricingLib extends NewFtpTreasuryBondYieldPricingDraft implements ILib, Serializable {
    /**
     * 变更编号
     * 版本号
     */
