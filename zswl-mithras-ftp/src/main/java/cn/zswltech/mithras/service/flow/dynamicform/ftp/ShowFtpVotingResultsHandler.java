...
@Component
public class ShowFtpVotingResultsHandler implements DynamicFormHandler {
    ...
    public void collect(TaskDetailRSP rsp) {
        ...
        List<VoteFormRSP.VoteRSP> voteRSPList = processApiService.queryVoteResult(rsp.getProcessInstanceId(), "userTask_pricing_committee")
                .stream()
                // 一人一票 去重
    ...
    public FlowDynamicFormEnum getType() {
        return FlowDynamicFormEnum.ftp_showVotingResults;
    }
