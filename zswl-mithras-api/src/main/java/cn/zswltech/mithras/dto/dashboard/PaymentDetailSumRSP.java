 ...
 */
@Data
public class PaymentDetailSumRSP {
    @ApiModelProperty("付款/投放阶段列表")
    private List<DashboardProjectStagePaymentDetailRSP> list;

    @ApiModelProperty("合计")
    private PaymentDetailSumRSP.SumData sumData;
