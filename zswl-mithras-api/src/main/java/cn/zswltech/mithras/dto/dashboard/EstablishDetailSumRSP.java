 ...
 */
@Data
public class EstablishDetailSumRSP {
    @ApiModelProperty("立项阶段列表")
    private List<DashboardProjectStageEstablishDetailRSP> list;

    @ApiModelProperty("合计")
    private EstablishDetailSumRSP.SumData sumData;
