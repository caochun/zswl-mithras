...
public class ProjReviewPriceModifyREQ {
    @ApiModelProperty("租赁报价方案请求体")
    private ProjReviewLeasePriceModifyREQ leasePriceModifyREQ;
    @ApiModelProperty("保理报价方案请求体")
    private ProjReviewFactoringPriceModifyREQ factoringPriceModifyREQ;
    @ApiModelProperty("债权转让报价方案请求体")
    private ProjReviewAocPriceModifyREQ aocPriceModifyREQ;
