 ...
 */
@Data
public class AssociationDetailBasicSituationRSP extends AssociationDetailBaseRSP{
     ...
     * 经济成分
     */
    @ApiModelProperty(value = "经济成分code")
    private String econClasCode;

    @ApiModelProperty(value = "经济成分Display")
    private String econClasDisplay;
    ...
    @ApiModelProperty(value = "是否中央企业控股Display")
    private String ctarCorpHoldFlagDisplay;
    ...
    @ApiModelProperty(value = "是否地方国企控股Display")
    private String lcalSoeHoldFlagDisplay;
    ...
    @ApiModelProperty(value = "企业类别Display")
    private String corpClasDisplay;
