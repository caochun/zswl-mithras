 ...
 */
@Data
@ApiModel("资产减值预测详情记录表列表-返回体")
public class EclExecutePredictRecordListRSP {
    ...
    * 拨备预测记录表id
    */
    @ApiModelProperty(value = "拨备预测记录表id")
    private String budgetPlanProfitDetail;
    ...
    */
    ...
    @ApiModelProperty(value = "上迁债项阶段")
    private Integer promotionResult;


    @ApiModelProperty(value = "手工债项阶段")
    ...
    */
     ...
     */
    @ApiModelProperty("是否逾期计算 0 非逾期计算 ,1逾期计算")
