 ...
 */
@Data
public class ContractDetailSumRSP {
    @ApiModelProperty("签约阶段列表")
    private List<DashboardProjectStageContractDetailRSP> list;

    @ApiModelProperty("合计")
    private ContractDetailSumRSP.SumData sumData;
