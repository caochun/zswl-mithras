 ...
 */
@Data
@ApiModel("帐龄-详情表编辑-请求体")
public class FinanceAccountAgeItemModifyREQ {
    ...
    */
    ...
    private Integer originalValueInitial;

    /**
    * 本期增加额 >0增加 <0减少
    */
    @ApiModelProperty(value = "本期增加额 >0增加 <0减少")
    private Integer originalValueIncrease;

    /**
    * 期末款项原值
    */
    @ApiModelProperty(value = "期末款项原值")
    private Integer originalValueFinal;
