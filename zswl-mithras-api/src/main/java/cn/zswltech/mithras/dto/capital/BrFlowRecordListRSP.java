...
public class BrFlowRecordListRSP {
    ...
    * 账户编码
    */
    @ApiModelProperty(value = "账户编码 == 银行账号")
    ...
    * 交易方向1支出，2收入
    */
    @ApiModelProperty(value = "交易方向1支出，2收入 1. 交易方向=支出，则“交易金额”对应“付款金额”；2. 交易方向=收入，则“交易金额”对应“收款金额”。")
    ...
    * 备注
    */
    @ApiModelProperty(value = "备注 用途 + 备注，拼接后 对应 “摘要”")
    ...
    */
     ...
     */
    @ApiModelProperty(value = "是否忽略，0：未忽略，1：已忽略，默认0")
