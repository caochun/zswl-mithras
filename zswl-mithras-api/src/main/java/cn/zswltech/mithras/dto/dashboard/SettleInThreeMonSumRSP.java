 ...
 */
@Data
public class SettleInThreeMonSumRSP {
    @ApiModelProperty("3个月内结清项目列表")
    private List<DashboardProjectInfoSettleInThreeMonthRSP> list;

    @ApiModelProperty("合计")
    private SettleInThreeMonSumRSP.SumData sumData;
