...
public class ProjPricingPriceDetailRSP {
    @ApiModelProperty("租赁报价方案")
    private ProjPricingLeasePriceRSP leasePriceDetailRSP;
    @ApiModelProperty("保理报价方案")
    private ProjPricingFactoringPriceRSP factoringPriceDetailRSP;
    @ApiModelProperty("债权转让报价方案")
    private ProjPricingAocPriceRSP aocPriceDetailRSP;

    public Long getProjectPricingId() {
