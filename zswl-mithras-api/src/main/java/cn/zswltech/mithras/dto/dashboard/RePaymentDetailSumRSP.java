 ...
 */
@Data
public class RePaymentDetailSumRSP {
    @ApiModelProperty("还款阶段列表")
    private List<DashboardProjectStageRepaymentDetailRSP> list;

    @ApiModelProperty("合计")
    private RePaymentDetailSumRSP.SumData sumData;
