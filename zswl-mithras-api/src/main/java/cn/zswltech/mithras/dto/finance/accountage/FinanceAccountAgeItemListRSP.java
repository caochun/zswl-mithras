 ...
 */
@Data
@ApiModel("帐龄-详情表列表-返回体")
public class FinanceAccountAgeItemListRSP {
    ...
    * 状态
    */
    @ApiModelProperty(value = "状态 FinancialAccountAgeSendStatusStatus")
    ...
    */
    ...
    @ApiModelProperty("来源 0系统生成 ,1 人工创建")
