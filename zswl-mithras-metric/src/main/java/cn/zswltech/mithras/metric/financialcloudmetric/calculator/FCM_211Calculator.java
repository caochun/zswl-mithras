...
public class FCM_211Calculator extends TwoMetricCalculator {
    ...
    @Resource
    private FinancialCloudMetricValueReader cloudMetricValueReader;
    ...
    public BigDecimal calculate(LocalDate dateTime) {
        FinancialCloudMetricValue fcm179 = cloudMetricValueReader.getMetricValue("FCM_179", dateTime);
        FinancialCloudMetricValue fcm207 = cloudMetricValueReader.getMetricValue("FCM_207", dateTime.with(TemporalAdjusters.firstDayOfYear()));
