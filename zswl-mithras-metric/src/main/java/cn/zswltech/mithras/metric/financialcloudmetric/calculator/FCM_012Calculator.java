 ...
 */
@Component
public class FCM_012Calculator extends FinancialReportRelatedCalculator {
    ...
    public BigDecimal calculate(LocalDate dateTime) {
        ...
        RiskMetricFactor factor2 = getFactor("二、营业总成本@本年累计数", "利润表", dateTime);
        return new BigDecimal(factor1.getFactorValue())
                .multiply(new BigDecimal(1000000))
                .divide(new BigDecimal(factor2.getFactorValue()), 10, RoundingMode.HALF_UP);
    }
}
