...
import static cn.zswltech.mithras.metric.aggregator.AggConst.ARCH_ENGINEERING_INDUSTRY_CODE;
 ...
 */
@Component
public class JC040Calculator implements MetricCalculator {
    ...
    public Map<String, Long> varMap(LocalDate date) {
        ...
        RiskMetricDict dict = metricDictService.getOne(Wrappers.<RiskMetricDict>lambdaQuery()
                ...
                .eq(RiskMetricDict::getDictKey, "ARCH_ENGINEERING")
        );
        ...
        wrapper.eq("industry_type", ARCH_ENGINEERING_INDUSTRY_CODE);
